            ...
            <v-col cols="12" md="6">
              <div class="d-flex align-center">
                ...
                <div>
                  ...
                  <div class="text-caption opacity-80">Manage your purchase orders</div>
                </div>
              </div>
            </v-col>
...
.status-summary-card .text-caption {
  font-family: 'Noto Sans Lao', 'Phetsarath OT', 'Lao UI', 'Arial', sans-serif !important;
}
