          ...
          >
            ...
            <template v-slot:item.jobCode="{ item }">
              <div class="d-flex align-center">
                ...
                <span class=" font-weight-bold">{{ item.jobCode }}</span>
              </div>
            </template>
            ...
            <template v-slot:item.employerCompany="{ item }">
              <div class="d-flex align-center">
                ...
                <span class="">{{ item.employerCompany }}</span>
              </div>
            </template>
            ...
            <template v-slot:item.workLocation="{ item }">
              <div class="d-flex align-center">
                ...
                <span class="">{{ item.workLocation }}</span>
              </div>
            </template>
            ...
            <template v-slot:item.numberOfWorkers="{ item }">
              <div class="d-flex align-center justify-center">
                ...
                <span class=" font-weight-bold">{{ item.numberOfWorkers }}</span>
              </div>
            </template>
            ...
            <template v-slot:item.agency="{ item }">
              <div class="d-flex align-center">
                ...
                <span class="">{{ item.agency?.agencyName || '-' }}</span>
              </div>
            </template>
