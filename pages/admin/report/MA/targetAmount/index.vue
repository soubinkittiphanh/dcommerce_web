              ...
              <template v-slot:default>
                <thead>
                  <tr class="custom-table-header">
                    ...
                    <th class="white--text  font-weight-bold">ແຜນລາຍຮັບ</th>
                    ...
                    <th class="white--text  font-weight-bold text-right">ບັນລຸ (LAK)</th>
                    <th class="white--text  font-weight-bold text-right">ຍັງເຫລືອ (LAK)</th>
                    <th class="white--text  font-weight-bold text-center">ຄວາມຄືບຫນ້າ</th>
                    <th class="white--text  font-weight-bold text-center">ສະຖານະ</th>
                  </tr>
                </thead>
                <tbody>
                  <tr v-for="(item, index) in dashboardData" :key="item.id" :class="{
                    ...
                    <td class="text-body-2">
                      ...
                      <div class=" grey--text">{{ item.year }}</div>
                    </td>
                    <td class="text-body-2">
                      <div class="font-weight-medium">{{ item.ministryCode || 'N/A' }} </div>
                      <div class=" grey--text">{{ item.ministryName || 'No Ministry' }}</div>
                    </td>
                    <td class="text-body-2">
                  ...
                  <tr class="custom-table-totals">
                    <td colspan="4" class="font-weight-bold  white--text">
                      ລວມ (Total)
                    </td>
