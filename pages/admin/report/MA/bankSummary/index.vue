...
.report-header {
  ...
  margin-bottom: 24px;
  padding: 20px;
  background: linear-gradient(135deg, primary 0%, #0D4F3C 50%, #1A5D4A 100%);
  color: white;
  border-radius: 8px;
...
.advance-card {
  background: linear-gradient(135deg, primary 0%, #0D4F3C 100%);
  color: white;
}
...
.dialog-title {
  background: linear-gradient(90deg, primary 0%, #0D4F3C 100%);
  color: white;
  font-weight: 600;
}
