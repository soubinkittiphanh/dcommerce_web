  ...
  <div>
    ...
    <div class="d-flex align-center mb-6">
      <v-avatar color="primary lighten-5" rounded size="48" class="mr-4">
        <v-icon color="primary" large>mdi-file-clock-outline</v-icon>
      </v-avatar>
      <div>
        <h1 class="text-h5 font-weight-bold mb-1 primary--text">ໃບແຈ້ງໜີ້ຄ້າງຈ່າຍ</h1>
        <p class="text-caption grey--text text--darken-1 mb-0">AP Invoice Management & Tracking</p>
      </div>
      <v-spacer />
      <v-btn color="primary" depressed large @click="openDialog()" class="rounded-lg font-weight-bold">
        <v-icon left>mdi-plus</v-icon>
        <span>ສ້າງໃບແຈ້ງໜີ້ໃໝ່</span>
      </v-btn>
    </div>
