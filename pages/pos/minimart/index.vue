      ...
      <v-row v-if="filterProduct.length > 0">
        <v-col cols="12">
          ...
          <div v-if="hasMoreProducts" class="text-center mt-4">
            <v-btn @click="loadMoreProducts" :loading="loadingMore" color="primary" outlined block>
              ເບິ່ງເພີ່ມເຕີມ ({{
      ...
      <v-row v-else>
        <v-col cols="12">
          <div class="text-center pa-8">
            ...
            <v-btn v-if="isSearchActive || isCategoryFiltered" @click="clearFilters" color="primary" outlined
              class="mt-4">
              ລົບຕົວກອງ
            </v-btn>
          </div>
