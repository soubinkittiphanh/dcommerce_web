...
const _6d42a028 = () => interopDefault(import('../pages/admin/moneyAdvanceByBank/index.vue' /* webpackChunkName: "pages/admin/moneyAdvanceByBank/index" */))
...
const _28480da5 = () => interopDefault(import('../pages/admin/ordersFromPosGrade/index.vue' /* webpackChunkName: "pages/admin/ordersFromPosGrade/index" */))
...
const _d7ca1168 = () => interopDefault(import('../pages/admin/printers/index.vue' /* webpackChunkName: "pages/admin/printers/index" */))
...
const _558cfc21 = () => interopDefault(import('../pages/admin/transaction_code/index.vue' /* webpackChunkName: "pages/admin/transaction_code/index" */))
...
const _6ac8385c = () => interopDefault(import('../pages/admin/accounting/project/index.vue' /* webpackChunkName: "pages/admin/accounting/project/index" */))
...
const _d3be8c8c = () => interopDefault(import('../pages/admin/job_fair/employee/index.vue' /* webpackChunkName: "pages/admin/job_fair/employee/index" */))
...
const _4cf27e8c = () => interopDefault(import('../pages/admin/report/MA/depositAccountSummary/index.vue' /* webpackChunkName: "pages/admin/report/MA/depositAccountSummary/index" */))
...
export const routerOptions = {
  ...
  routes: [{
    ...
    path: "/admin/ordersFromPosGrade",
    component: _28480da5,
    name: "admin-ordersFromPosGrade"
  }, {
    ...
    path: "/admin/saleReportSummary",
    component: _4ffb7b4e,
    name: "admin-saleReportSummary"
  }, {
    ...
    path: "/admin/shipping-order",
    component: _699b36bc,
    name: "admin-shipping-order"
  }, {
    path: "/admin/size",
    component: _beea3498,
    name: "admin-size"
    ...
    path: "/reports/stock-backdate",
    component: _7fa8bfec,
    name: "reports-stock-backdate"
  }, {
    ...
    component: _6bafd921,
    name: "admin-accounting-project-contracts"
  }, {
    ...
    path: "/admin/report/MA/depositAccountSummary",
    component: _4cf27e8c,
    name: "admin-report-MA-depositAccountSummary"
  }, {
