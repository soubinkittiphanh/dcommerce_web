...
var ministrySummaryvue_type_template_id_6966d95a_scoped_true_render = function render() {
  ...
  return _c('div', {
  ...
  }, [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.summaryData.totalBroughtForwardLcy)) + "\n              ")]), _vm._v(" "), _c('p', {
    ...
    staticClass: "summary-amount"
  }, [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.summaryData.totalCurrentMonthLcy)) + "\n              ")]), _vm._v(" "), _c('p', {
    staticClass: "summary-lcy"
  }, [_vm._v("LCY Amount")])])])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
    ...
    staticClass: "summary-amount"
  }, [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.summaryData.totalSettlementLcy)) + "\n              ")]), _vm._v(" "), _c('p', {
    staticClass: "summary-lcy"
  }, [_vm._v("LCY Amount")])])])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
    ...
    staticClass: "summary-amount"
  }, [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.summaryData.totalBalanceLcy)) + "\n              ")]), _vm._v(" "), _c('p', {
    staticClass: "summary-lcy"
  }, [_vm._v("LCY Amount")])])])])], 1)], 1)], 1), _vm._ssrNode(" "), _c(VCard["a" /* default */], {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        }, [_vm._v(_vm._s(item.ministryName))]), _vm._v(" "), _c('span', {
          staticClass: "ministry-code"
        }, [_vm._v(_vm._s(item.ministryCode))])])];
      }
    }, {
        ...
        return [_c(VBtn["a" /* default */], {
          ...
          on: {
            "click": function ($event) {
              return _vm.viewMinistryDetails(item);
            }
          }
        }, [_c('i', {
  ...
  }, [_c('strong', [_vm._v("ຍອດຍົກມາ:")]), _vm._v(" "), _c('p', [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.selectedMinistry.broughtForwardAmount)) + "\n                " + _vm._s(_vm.selectedMinistry.currencyCode) + "\n              ")]), _vm._v(" "), _c('small', [_vm._v("LCY:\n                " + _vm._s(_vm.formatCurrency(_vm.selectedMinistry.broughtForwardLcy)))])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6",
      "md": "3"
    }
    ...
    staticClass: "detail-stat"
  }, [_c('strong', [_vm._v("ລາຍຈ່າຍເດືອນນີ້:")]), _vm._v(" "), _c('p', [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.selectedMinistry.currentMonthAmount)) + "\n                " + _vm._s(_vm.selectedMinistry.currencyCode) + "\n              ")]), _vm._v(" "), _c('small', [_vm._v("LCY:\n                " + _vm._s(_vm.formatCurrency(_vm.selectedMinistry.currentMonthLcy)))])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6",
      "md": "3"
    }
    ...
    staticClass: "detail-stat"
  }, [_c('strong', [_vm._v("ຊຳລະເດືອນນີ້:")]), _vm._v(" "), _c('p', [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.selectedMinistry.settlementAmount)) + "\n                " + _vm._s(_vm.selectedMinistry.currencyCode) + "\n              ")]), _vm._v(" "), _c('small', [_vm._v("LCY:\n                " + _vm._s(_vm.formatCurrency(_vm.selectedMinistry.settlementLcy)))])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6",
      "md": "3"
    }
    ...
    class: _vm.getBalanceClass(_vm.selectedMinistry.balanceLcy)
  }, [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.selectedMinistry.balanceLcy)) + " LAK\n              ")])])])], 1), _vm._v(" "), _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
...
var ministrySummaryvue_type_script_lang_js_ = __webpack_require__(636);
  ...
  methods: {
    ...
    async applyFilters() {
      ...
      try {
        ...
        const response = await this.$axios.get(`/api/money-advances/ministry-summary?${params}`);
    ...
    initializeChart() {
      ...
      this.ministryChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0___default.a(ctx, {
        type: 'bar',
        data: {
          labels: [],
          datasets: [{
    ...
    async viewMinistryDetails(item) {
      ...
      try {
        ...
        const response = await this.$axios.get(`/api/money-advances/ministry-details?${params}`);
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await this.$axios.get(`/api/money-advances/ministry-summary/export?${params}`, {
          responseType: 'blob'
        });
