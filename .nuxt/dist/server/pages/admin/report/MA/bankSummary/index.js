...
var bankSummaryvue_type_template_id_6eef52f3_scoped_true_render = function render() {
  var _vm$selectedBankAccou, _vm$selectedBankAccou2;
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "bank-account-summary-report"
  }, [_vm._ssrNode("<div class=\"report-header\" data-v-6eef52f3>", "</div>", [_vm._ssrNode("<div class=\"title-section\" data-v-6eef52f3><h1 class=\"page-title\" data-v-6eef52f3><i class=\"fas fa-university\" data-v-6eef52f3></i>\n        ລາຍງານສະຫຼຸບຕາມບັນຊີທະນາຄານ\n      </h1> <p class=\"page-subtitle\" data-v-6eef52f3>Bank Account Summary Report</p></div> "), _vm._ssrNode("<div class=\"action-buttons\" data-v-6eef52f3>", "</div>", [_c(VBtn["a" /* default */], {
    attrs: {
      "color": "success",
      ...
      fn: function ({
        ...
        return [_c(VTextField["a" /* default */], _vm._g(_vm._b({
          ...
          model: {
            ...
            callback: function ($$v) {
              _vm.$set(_vm.filters, "reportMonth", $$v);
            },
            expression: "filters.reportMonth"
          }
  ...
  }, [_vm._v("ຍອດຍົກມາ")]), _vm._v(" "), _c('p', {
    staticClass: "summary-subtitle"
  }, [_vm._v("Total Brought Forward")]), _vm._v(" "), _c('h2', {
    staticClass: "summary-amount"
  }, [_vm._v(_vm._s(_vm.formatCurrency(_vm.summaryData.totalBroughtForwardLcy)))]), _vm._v(" "), _c('p', {
    staticClass: "summary-lcy"
  }, [_vm._v("LCY Amount")])])])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "md": "3"
    }
    ...
    staticClass: "summary-title"
  }, [_vm._v("ລາຍຈ່າຍເດືອນນີ້")]), _vm._v(" "), _c('p', {
    staticClass: "summary-subtitle"
  }, [_vm._v("Current Month Advances")]), _vm._v(" "), _c('h2', {
    staticClass: "summary-amount"
  }, [_vm._v(_vm._s(_vm.formatCurrency(_vm.summaryData.totalCurrentMonthLcy)))]), _vm._v(" "), _c('p', {
    staticClass: "summary-lcy"
  }, [_vm._v("LCY Amount")])])])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
    ...
    staticClass: "summary-title"
  }, [_vm._v("ຊຳລະເດືອນນີ້")]), _vm._v(" "), _c('p', {
    staticClass: "summary-subtitle"
  }, [_vm._v("Current Month Settlements")]), _vm._v(" "), _c('h2', {
    staticClass: "summary-amount"
  }, [_vm._v(_vm._s(_vm.formatCurrency(_vm.summaryData.totalSettlementLcy)))]), _vm._v(" "), _c('p', {
    staticClass: "summary-lcy"
  }, [_vm._v("LCY Amount")])])])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
    ...
    staticClass: "summary-title"
  }, [_vm._v("ຍອດສະຫຼຸບ")]), _vm._v(" "), _c('p', {
    staticClass: "summary-subtitle"
  }, [_vm._v("Total Balance")]), _vm._v(" "), _c('h2', {
    staticClass: "summary-amount"
  }, [_vm._v(_vm._s(_vm.formatCurrency(_vm.summaryData.totalBalanceLcy)))]), _vm._v(" "), _c('p', {
    staticClass: "summary-lcy"
  }, [_vm._v("LCY Amount")])])])])], 1)], 1)], 1), _vm._ssrNode(" "), _vm.summaryData.totalBankAccounts ? _c(VRow["a" /* default */], {
  ...
  }, [_vm._v(_vm._s(_vm.summaryData.totalBankAccounts || 0))]), _vm._v(" "), _c('p', {
    staticClass: "stats-label"
  }, [_vm._v("ທັງໝົດບັນຊີ"), _c('br'), _vm._v("Total Accounts")])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "md": "3"
    }
    ...
    staticClass: "stats-number"
  }, [_vm._v(_vm._s(_vm.summaryData.totalCurrencyLines || 0))]), _vm._v(" "), _c('p', {
    staticClass: "stats-label"
  }, [_vm._v("ລວມສາຍສະກຸນເງິນ"), _c('br'), _vm._v("Currency Lines")])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "md": "3"
    }
    ...
    staticClass: "stats-number"
  }, [_vm._v(_vm._s(_vm.summaryData.uniqueCurrencies || 0))]), _vm._v(" "), _c('p', {
    staticClass: "stats-label"
  }, [_vm._v("ສະກຸນເງິນທີ່ໃຊ້"), _c('br'), _vm._v("Unique Currencies")])])], 1)], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "12",
      "md": "3"
    }
    ...
    staticClass: "stats-number"
  }, [_vm._v(_vm._s(_vm.filters.reportMonth))]), _vm._v(" "), _c('p', {
    staticClass: "stats-label"
  }, [_vm._v("ເດືອນລາຍງານ"), _c('br'), _vm._v("Report Month")])])], 1)], 1)], 1) : _vm._e(), _vm._ssrNode(" "), _c(VCard["a" /* default */], {
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        }, [_vm._v(_vm._s(item.bankAccountName))]), _vm._v(" "), _c('span', {
      ...
      fn: function ({
        ...
        }, [_vm._v(_vm._s(_vm.formatCurrency(item.broughtForwardAmount)))]), _vm._v(" "), _c('div', {
          staticClass: "exchange-rate"
        }, [_vm._v("\n            Rate: " + _vm._s(_vm.formatExchangeRate(item.broughtForwardExchangeRate)) + "\n          ")])])];
      }
    }, {
      key: "item.broughtForwardLcy",
      fn: function ({
        item
      }) {
        return [_c('span', {
          staticClass: "amount-cell lcy-amount"
        }, [_vm._v("\n          " + _vm._s(_vm.formatCurrency(item.broughtForwardLcy)) + "\n        ")])];
      }
    }, {
      key: "item.currentMonthAmount",
      fn: function ({
        item
      }) {
        return [_c('div', {
          ...
          staticClass: "amount-cell"
        }, [_vm._v(_vm._s(_vm.formatCurrency(item.currentMonthAmount)))]), _vm._v(" "), _c('div', {
          staticClass: "exchange-rate"
        }, [_vm._v("\n            Rate: " + _vm._s(_vm.formatExchangeRate(item.currentMonthExchangeRate)) + "\n          ")])])];
      }
    }, {
      key: "item.currentMonthLcy",
      fn: function ({
        item
      }) {
        return [_c('span', {
          staticClass: "amount-cell advance-amount"
        }, [_vm._v("\n          " + _vm._s(_vm.formatCurrency(item.currentMonthLcy)) + "\n        ")])];
      }
    }, {
      ...
      fn: function ({
        ...
        return [_c('div', {
          ...
          staticClass: "amount-cell"
        }, [_vm._v(_vm._s(_vm.formatCurrency(item.settlementAmount)))]), _vm._v(" "), _c('div', {
          staticClass: "exchange-rate"
        }, [_vm._v("\n            Rate: " + _vm._s(_vm.formatExchangeRate(item.settlementExchangeRate)) + "\n          ")])])];
      }
    }, {
      key: "item.settlementLcy",
      fn: function ({
        item
      }) {
        return [_c('span', {
          staticClass: "amount-cell settlement-amount"
        }, [_vm._v("\n          " + _vm._s(_vm.formatCurrency(item.settlementLcy)) + "\n        ")])];
      }
    }, {
      key: "item.balanceLcy",
      fn: function ({
        ...
        return [_c('span', {
          staticClass: "amount-cell balance-amount",
          class: _vm.getBalanceClass(item.balanceLcy)
        }, [_vm._v("\n          " + _vm._s(_vm.formatCurrency(item.balanceLcy)) + "\n        ")])];
      }
    }, {
      key: "item.actions",
      fn: function ({
        ...
        return [_c(VBtn["a" /* default */], {
          ...
          on: {
            "click": function ($event) {
              return _vm.viewBankAccountDetails(item);
            }
          }
        }, [_c('i', {
  ...
  }), _vm._v("\n        ລາຍລະອຽດ - " + _vm._s((_vm$selectedBankAccou = _vm.selectedBankAccount) === null || _vm$selectedBankAccou === void 0 ? void 0 : _vm$selectedBankAccou.bankAccountName) + " (" + _vm._s((_vm$selectedBankAccou2 = _vm.selectedBankAccount) === null || _vm$selectedBankAccou2 === void 0 ? void 0 : _vm$selectedBankAccou2.currencyCode) + ")\n        "), _c(VSpacer["a" /* default */]), _vm._v(" "), _c(VBtn["a" /* default */], {
    attrs: {
      "icon": ""
    },
    on: {
  ...
  }, [_c(VIcon["a" /* default */], [_vm._v("mdi-close")])], 1)], 1), _vm._v(" "), _vm.selectedBankAccount ? _c(components_VCard["c" /* VCardText */], [_c(VRow["a" /* default */], {
    staticClass: "mb-4"
  }, [_c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
  }, [_c('h3', [_vm._v("ສະຫຼຸບ - " + _vm._s(_vm.selectedBankAccount.currencyCode) + " (Summary)")]), _vm._v(" "), _c(VDivider["a" /* default */], {
    staticClass: "mb-3"
  })], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6",
  ...
  }, [_c('strong', [_vm._v("ຍອດຍົກມາ:")]), _vm._v(" "), _c('p', [_vm._v(_vm._s(_vm.formatCurrency(_vm.selectedBankAccount.broughtForwardAmount)) + " " + _vm._s(_vm.selectedBankAccount.currencyCode))]), _vm._v(" "), _c('small', [_vm._v("LCY: " + _vm._s(_vm.formatCurrency(_vm.selectedBankAccount.broughtForwardLcy)))])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6",
      "md": "3"
    }
    ...
    staticClass: "detail-stat"
  }, [_c('strong', [_vm._v("ລາຍຈ່າຍເດືອນນີ້:")]), _vm._v(" "), _c('p', [_vm._v(_vm._s(_vm.formatCurrency(_vm.selectedBankAccount.currentMonthAmount)) + " " + _vm._s(_vm.selectedBankAccount.currencyCode))]), _vm._v(" "), _c('small', [_vm._v("LCY: " + _vm._s(_vm.formatCurrency(_vm.selectedBankAccount.currentMonthLcy)))])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6",
      "md": "3"
    }
    ...
    staticClass: "detail-stat"
  }, [_c('strong', [_vm._v("ຊຳລະເດືອນນີ້:")]), _vm._v(" "), _c('p', [_vm._v(_vm._s(_vm.formatCurrency(_vm.selectedBankAccount.settlementAmount)) + " " + _vm._s(_vm.selectedBankAccount.currencyCode))]), _vm._v(" "), _c('small', [_vm._v("LCY: " + _vm._s(_vm.formatCurrency(_vm.selectedBankAccount.settlementLcy)))])])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6",
      "md": "3"
    }
    ...
    staticClass: "detail-stat"
  }, [_c('strong', [_vm._v("ຍອດສະຫຼຸບ:")]), _vm._v(" "), _c('p', {
    staticClass: "balance-text",
    class: _vm.getBalanceClass(_vm.selectedBankAccount.balanceLcy)
  }, [_vm._v("\n                " + _vm._s(_vm.formatCurrency(_vm.selectedBankAccount.balanceLcy)) + " LAK\n              ")])])])], 1), _vm._v(" "), _c(VRow["a" /* default */], {
    staticClass: "mb-4"
  }, [_c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
  }, [_c('h3', [_vm._v("ຂໍ້ມູນບັນຊີ (Account Information)")]), _vm._v(" "), _c(VDivider["a" /* default */], {
    staticClass: "mb-3"
  })], 1), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6"
  ...
  }, [_c('strong', [_vm._v("ຊື່ບັນຊີ:")]), _vm._v(" " + _vm._s(_vm.selectedBankAccount.bankAccountName) + "\n            ")]), _vm._v(" "), _c('div', {
    staticClass: "detail-item"
  }, [_c('strong', [_vm._v("ເລກບັນຊີ:")]), _vm._v(" " + _vm._s(_vm.selectedBankAccount.bankAccountNumber) + "\n            ")])]), _vm._v(" "), _c(VCol["a" /* default */], {
    attrs: {
      "cols": "6"
    }
  }, [_c('div', {
    staticClass: "detail-item"
  }, [_c('strong', [_vm._v("ທະນາຄານ:")]), _vm._v(" " + _vm._s(_vm.selectedBankAccount.bankName) + "\n            ")]), _vm._v(" "), _c('div', {
    staticClass: "detail-item"
  }, [_c('strong', [_vm._v("ສະກຸນເງິນ:")]), _vm._v(" " + _vm._s(_vm.selectedBankAccount.currencyCode) + "\n            ")])])], 1), _vm._v(" "), _c(VRow["a" /* default */], [_c(VCol["a" /* default */], {
    attrs: {
      "cols": "12"
    }
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function ({
        ...
        }, [_vm._v(_vm._s(item.referenceNumber))])];
      }
    }, {
      key: "item.amount",
      fn: function ({
        ...
        return [_c('div', {
          ...
          staticClass: "amount-cell"
        }, [_vm._v(_vm._s(_vm.formatCurrency(item.amount)))]), _vm._v(" "), _c('span', {
          staticClass: "currency-code"
        }, [_vm._v(_vm._s(item.currencyCode))]), _vm._v(" "), _c('div', {
          staticClass: "exchange-rate"
        }, [_vm._v("Rate: " + _vm._s(_vm.formatExchangeRate(item.exchangeRate)))])])];
      }
    }, {
      key: "item.lcyAmount",
      fn: function ({
        ...
        return [_c('span', {
          staticClass: "amount-cell lcy-amount"
        }, [_vm._v(_vm._s(_vm.formatCurrency(item.lcyAmount)))])];
      }
    }, {
      key: "item.type",
      fn: function ({
        ...
        }, [_vm._v("\n                  " + _vm._s(_vm.getTypeText(item.type)) + "\n                ")])];
      }
    }], null, false, 3049267697)
  })], 1)], 1)], 1) : _vm._e()], 1)], 1)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/admin/report/MA/bankSummary/index.vue?vue&type=template&id=6eef52f3&scoped=true&
...
var bankSummaryvue_type_script_lang_js_ = __webpack_require__(634);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  bankSummaryvue_type_template_id_6eef52f3_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "6eef52f3",
...
const chartjs = __webpack_require__(458);
const {
  Chart,
  registerables
} = chartjs;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(URLSearchParams) {/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(488);
/* harmony import */ var chart_js_auto__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(chart_js_auto__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  data() {
    return {
      ...
      tableHeaders: [{
        ...
        text: 'ຍອດຍົກມາ',
        value: 'broughtForwardAmount',
        width: '130px'
      }, {
        text: 'LCY',
        value: 'broughtForwardLcy',
        width: '100px'
      }, {
  ...
  methods: {
    ...
    initializeChart() {
      ...
      this.bankAccountChart = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0___default.a(ctx, {
        type: 'bar',
        data: {
          labels: [],
          datasets: [{
...
module.exports.__inject__ = function (context) {
  add("766f17de", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_6eef52f3_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(738);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_6eef52f3_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_6eef52f3_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_6eef52f3_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_6eef52f3_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".bank-account-summary-report[data-v-6eef52f3]{padding:0}.report-header[data-v-6eef52f3]{align-items:center;background:linear-gradient(135deg,#667eea,#764ba2);border-radius:8px;color:#fff;display:flex;justify-content:space-between;margin-bottom:24px;padding:20px}.title-section h1[data-v-6eef52f3]{font-size:28px;font-weight:600;margin:0}.title-section p[data-v-6eef52f3]{font-size:14px;margin:5px 0 0;opacity:.9}.action-buttons[data-v-6eef52f3]{display:flex;gap:12px}.action-buttons .v-btn[data-v-6eef52f3]{color:#fff!important}.filter-card[data-v-6eef52f3]{background:#fff}.filter-title[data-v-6eef52f3]{background:#f8f9fa;color:#495057;font-weight:600}.filter-actions[data-v-6eef52f3]{align-items:center;display:flex;gap:12px;margin-top:20px}.bank-account-selection[data-v-6eef52f3]{display:flex;flex-direction:column}.bank-account-selection .bank-name[data-v-6eef52f3]{font-size:14px;font-weight:600}.bank-account-selection small[data-v-6eef52f3]{color:#666;font-size:11px}.bank-account-item[data-v-6eef52f3]{padding:8px 0}.bank-account-item .bank-name[data-v-6eef52f3]{font-size:14px;font-weight:600}.bank-account-item .bank-details[data-v-6eef52f3]{color:#666;font-size:12px;margin-top:2px}.summary-cards[data-v-6eef52f3]{margin-bottom:24px}.summary-card[data-v-6eef52f3]{height:140px;overflow:hidden;position:relative}.summary-content[data-v-6eef52f3]{align-items:center;display:flex;height:100%}.summary-icon[data-v-6eef52f3]{font-size:48px;margin-right:16px;opacity:.8}.summary-details h3[data-v-6eef52f3]{color:#333;font-size:16px;font-weight:600;margin:0}.summary-details p[data-v-6eef52f3]{color:#666;font-size:12px;margin:4px 0}.summary-details h2[data-v-6eef52f3]{font-size:24px;font-weight:700;margin:8px 0 0}.summary-lcy[data-v-6eef52f3]{font-size:11px;margin-top:4px!important;opacity:.8}.brought-forward-card[data-v-6eef52f3]{background:linear-gradient(135deg,#a8edea,#fed6e3);color:#333}.advance-card[data-v-6eef52f3]{background:linear-gradient(135deg,#667eea,#764ba2);color:#fff}.settlement-card[data-v-6eef52f3]{background:linear-gradient(135deg,#f093fb,#f5576c);color:#fff}.balance-card[data-v-6eef52f3]{background:linear-gradient(135deg,#ffecd2,#fcb69f);color:#333}.additional-summary[data-v-6eef52f3]{margin-bottom:24px}.stats-card[data-v-6eef52f3]{height:100px}.stats-number[data-v-6eef52f3]{font-size:24px;font-weight:700;margin:0}.stats-label[data-v-6eef52f3]{font-size:11px;line-height:1.2;margin:4px 0 0}.chart-card[data-v-6eef52f3]{margin-bottom:24px}.chart-container[data-v-6eef52f3]{height:400px;position:relative}.table-card[data-v-6eef52f3]{margin-bottom:24px}.table-title[data-v-6eef52f3]{background:#f8f9fa;color:#495057;font-weight:600}.search-field[data-v-6eef52f3]{max-width:300px}.report-table[data-v-6eef52f3]{background:#fff}.bank-account-cell[data-v-6eef52f3]{display:flex;flex-direction:column}.bank-account-name[data-v-6eef52f3]{font-size:14px;font-weight:600}.bank-account-number[data-v-6eef52f3]{color:#666;font-family:monospace;font-size:11px}.bank-name[data-v-6eef52f3]{color:#999;font-size:12px;font-style:italic}.amount-breakdown[data-v-6eef52f3]{align-items:center;display:flex;flex-direction:column}.amount-cell[data-v-6eef52f3]{font-family:monospace;font-size:13px;font-weight:600}.currency-code[data-v-6eef52f3]{background:#e9ecef;border-radius:12px;color:#495057;font-size:10px;padding:2px 6px}.exchange-rate[data-v-6eef52f3]{color:#666;font-size:10px;margin-top:2px}.lcy-amount[data-v-6eef52f3]{color:#6f42c1}.advance-amount[data-v-6eef52f3]{color:#667eea}.settlement-amount[data-v-6eef52f3]{color:#28a745}.balance-amount[data-v-6eef52f3]{font-weight:700}.positive-balance[data-v-6eef52f3]{color:#28a745}.negative-balance[data-v-6eef52f3]{color:#dc3545}.zero-balance[data-v-6eef52f3]{color:#6c757d}.detail-stat[data-v-6eef52f3]{background:#f8f9fa;border-radius:8px;padding:12px;text-align:center}.detail-stat strong[data-v-6eef52f3]{color:#495057;display:block;font-size:14px;margin-bottom:8px}.detail-stat p[data-v-6eef52f3]{font-family:monospace;font-size:18px;font-weight:600;margin:0}.detail-stat small[data-v-6eef52f3]{color:#666;display:block;font-size:11px;font-style:italic;margin-top:4px}.balance-text[data-v-6eef52f3]{font-weight:700}.detail-item[data-v-6eef52f3]{font-size:14px;margin-bottom:12px}.detail-item strong[data-v-6eef52f3]{color:#495057}.detail-table[data-v-6eef52f3]{margin-top:16px}.date-cell[data-v-6eef52f3]{font-family:monospace;font-size:13px}.reference-cell[data-v-6eef52f3]{background:#f8f9fa;border-radius:4px;color:#666;font-family:monospace;font-size:12px;padding:2px 6px}@media print{.action-buttons[data-v-6eef52f3],.filter-card[data-v-6eef52f3],.v-btn[data-v-6eef52f3]{display:none!important}.additional-summary[data-v-6eef52f3],.chart-card[data-v-6eef52f3],.summary-cards[data-v-6eef52f3]{page-break-inside:avoid}}@media (max-width:768px){.report-header[data-v-6eef52f3]{gap:16px}.report-header[data-v-6eef52f3],.summary-content[data-v-6eef52f3]{flex-direction:column;text-align:center}.summary-icon[data-v-6eef52f3]{margin-bottom:8px;margin-right:0}.chart-container[data-v-6eef52f3]{height:300px}.filter-actions[data-v-6eef52f3]{flex-direction:column;width:100%}.filter-actions .v-btn[data-v-6eef52f3]{width:100%}.stats-card[data-v-6eef52f3]{height:80px}.stats-number[data-v-6eef52f3]{font-size:18px}.stats-label[data-v-6eef52f3]{font-size:10px}.amount-breakdown[data-v-6eef52f3]{font-size:12px}.detail-stat[data-v-6eef52f3]{padding:8px}.detail-stat p[data-v-6eef52f3]{font-size:14px}}.v-data-table[data-v-6eef52f3] .v-data-table__progress{animation:loading-6eef52f3 1.5s infinite;background:linear-gradient(90deg,#f0f0f0 25%,#e0e0e0 50%,#f0f0f0 75%);background-size:200% 100%}@keyframes loading-6eef52f3{0%{background-position:200% 0}to{background-position:-200% 0}}.v-dialog .v-card-text[data-v-6eef52f3]{max-height:70vh;overflow-y:auto}.v-dialog .v-card-text[data-v-6eef52f3]::-webkit-scrollbar{width:6px}.v-dialog .v-card-text[data-v-6eef52f3]::-webkit-scrollbar-track{background:#f1f1f1;border-radius:3px}.v-dialog .v-card-text[data-v-6eef52f3]::-webkit-scrollbar-thumb{background:#c1c1c1;border-radius:3px}.v-dialog .v-card-text[data-v-6eef52f3]::-webkit-scrollbar-thumb:hover{background:#a8a8a8}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
