...
var bankAccountvue_type_template_id_061f3d6a_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "bank-account-settlement-report"
  }, [_vm._ssrNode("<div class=\"report-header\" data-v-061f3d6a>", "</div>", [_vm._ssrNode("<div class=\"title-section\" data-v-061f3d6a><h1 class=\"page-title\" data-v-061f3d6a><i class=\"fas fa-university\" data-v-061f3d6a></i>\n        ລາຍງານຊຳລະຕາມບັນຊີທະນາຄານ\n      </h1> <p class=\"page-subtitle\" data-v-061f3d6a>Bank Account Settlement Report</p></div> "), _vm._ssrNode("<div class=\"action-buttons\" data-v-061f3d6a>", "</div>", [_c(VBtn["a" /* default */], {
    attrs: {
      "color": "success",
  ...
  }), 1)], 1)], 1)], 1)], 1) : _vm._e(), _vm._ssrNode(" "), _vm.loading ? _vm._ssrNode("<div class=\"text-center py-8\" data-v-061f3d6a>", "</div>", [_c(VProgressCircular["a" /* default */], {
    attrs: {
      "indeterminate": "",
      "color": "primary",
      "size": "64"
    }
  }), _vm._ssrNode(" <p class=\"mt-4 text-gray-600\" data-v-061f3d6a>\n      ກຳລັງໂຫລດຂໍ້ມູນ... Loading bank account reports...\n    </p>")], 2) : _vm._e(), _vm._ssrNode(" "), !_vm.loading && _vm.bankAccountStats.length > 0 ? _c(VCard["a" /* default */], {
  ...
  })], 1), _vm._v(" "), _vm.bankAccountStats.length > 0 ? _c(components_VCard["c" /* VCardText */], [_c(VRow["a" /* default */], _vm._l(_vm.filteredBankAccounts, function (stat) {
    var _vm$selectedBankAccou, _stat$bankAccount, _stat$bankAccount2, _stat$bankAccount3;
    return _c(VCol["a" /* default */], {
      ...
      staticClass: "bank-account-card",
      class: {
        selected: ((_vm$selectedBankAccou = _vm.selectedBankAccount) === null || _vm$selectedBankAccou === void 0 ? void 0 : _vm$selectedBankAccou.id) == stat.bankAccountId
      },
      attrs: {
        "elevation": "2"
      },
      on: {
        "click": function ($event) {
          return _vm.selectBankAccount(stat.bankAccountId);
        }
      }
    }, [_c(components_VCard["c" /* VCardText */], [_c('div', {
      staticClass: "bank-account-header"
    }, [_c('div', {
      staticClass: "bank-info"
    }, [_c('h3', {
      staticClass: "bank-account-name"
    }, [_vm._v("\n                    " + _vm._s(((_stat$bankAccount = stat.bankAccount) === null || _stat$bankAccount === void 0 ? void 0 : _stat$bankAccount.accountName) || 'Unknown Account') + "\n                  ")]), _vm._v(" "), _c('p', {
      staticClass: "bank-account-number"
    }, [_vm._v("\n                    " + _vm._s((_stat$bankAccount2 = stat.bankAccount) === null || _stat$bankAccount2 === void 0 ? void 0 : _stat$bankAccount2.accountNumber) + "\n                  ")]), _vm._v(" "), _c('p', {
      staticClass: "bank-name"
    }, [_vm._v("\n                    " + _vm._s(((_stat$bankAccount3 = stat.bankAccount) === null || _stat$bankAccount3 === void 0 ? void 0 : _stat$bankAccount3.bankName) || 'N/A') + "\n                  ")])]), _vm._v(" "), _c('div', {
    ...
    }, [_vm._v("\n                    $" + _vm._s(_vm.formatCurrency(stat.total)) + "\n                  ")])]), _vm._v(" "), _c('div', {
      staticClass: "stat-item"
    }, [_c('span', {
      staticClass: "stat-label"
  ...
  }, [_vm._v("ບໍ່ມີຂໍ້ມູນບັນຊີທະນາຄານ")]), _vm._v(" "), _c('p', {
    ...
    }], null, false, 1833622732)
  })], 1)], 1)], 1)], 1) : _vm._e()], 1)], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/admin/report/MA/settlement/bankAccount/index.vue?vue&type=template&id=061f3d6a&scoped=true&
...
var bankAccountvue_type_script_lang_js_ = __webpack_require__(639);
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  bankAccountvue_type_template_id_061f3d6a_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "061f3d6a",
...
"use strict";
/* WEBPACK VAR INJECTION */(function(URLSearchParams) {/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(458);
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    totalSettlementsCount() {
      return this.bankAccountStats.reduce((sum, account) => sum + parseInt(account.count), 0);
    },
    totalAmount() {
      return this.bankAccountStats.reduce((sum, account) => sum + parseFloat(account.total), 0);
    },
    averageAmount() {
      return this.totalSettlementsCount > 0 ? this.totalAmount / this.totalSettlementsCount : 0;
    },
    maxAmount() {
      return Math.max(...this.bankAccountStats.map(account => parseFloat(account.total)), 0);
    }
  },
  mounted() {
  ...
  methods: {
    ...
    async loadDashboardData() {
      ...
      try {
        ...
        const response = await this.$axios.get(`/api/settlements/dashboard?${params}`);
    ...
    initializeChart() {
      if (this.$refs.bankAccountChart) {
        ...
        this.bankAccountChart = new chart_js__WEBPACK_IMPORTED_MODULE_0___default.a(ctx, {
          type: 'bar',
          data: {
            labels: [],
            datasets: [{
    ...
    updateChart() {
      ...
      const labels = this.bankAccountStats.map(stat => {
        var _stat$bankAccount;
        return `${((_stat$bankAccount = stat.bankAccount) === null || _stat$bankAccount === void 0 ? void 0 : _stat$bankAccount.accountName) || 'Unknown'}`;
      }).slice(0, 10); // Limit to top 10

      const amounts = this.bankAccountStats.map(stat => parseFloat(stat.total)).slice(0, 10);
      const counts = this.bankAccountStats.map(stat => parseInt(stat.count)).slice(0, 10);
    ...
    async exportToExcel() {
      ...
      try {
        ...
        const response = await this.$axios.get(`/api/settlements/dashboard/export?${params}`, {
          responseType: 'blob'
        });
...
module.exports.__inject__ = function (context) {
  add("3b3c767c", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_061f3d6a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(744);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_061f3d6a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_061f3d6a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_061f3d6a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_061f3d6a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
