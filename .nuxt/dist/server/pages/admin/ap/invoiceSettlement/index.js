...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("5a6bb194", content, true, context)
};
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("917f2644", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_531c2eb3_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(544);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_531c2eb3_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_531c2eb3_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_531c2eb3_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_531c2eb3_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".settlement-audit-dialog-overlay[data-v-531c2eb3]{align-items:center;background-color:rgba(0,0,0,.6);display:flex;height:100%;justify-content:center;left:0;padding:20px;position:fixed;top:0;width:100%;z-index:1060}.settlement-audit-dialog[data-v-531c2eb3]{background:#fff;border-radius:12px;box-shadow:0 10px 30px rgba(0,0,0,.3);display:flex;flex-direction:column;max-height:95vh;max-width:1400px;overflow:hidden;width:100%}.settlement-audit-dialog-header[data-v-531c2eb3]{align-items:center;background:linear-gradient(135deg,#a12f8d,#337555);border-bottom:1px solid #e9ecef;color:#fff;display:flex;justify-content:space-between;padding:20px}.header-info h3[data-v-531c2eb3]{align-items:center;display:flex;font-size:20px;font-weight:600;gap:10px;margin:0}.settlement-subtitle[data-v-531c2eb3]{font-size:14px;margin:5px 0 0;opacity:.9}.close-btn[data-v-531c2eb3]{align-items:center;background:none;border:none;border-radius:50%;color:#fff;cursor:pointer;display:flex;font-size:20px;height:36px;justify-content:center;padding:8px;transition:background-color .2s;width:36px}.close-btn[data-v-531c2eb3]:hover{background:hsla(0,0%,100%,.2)}.settlement-audit-dialog-body[data-v-531c2eb3]{background:#f8f9fa;flex:1;min-height:0;overflow-x:hidden;overflow-y:auto;padding:0}.settlement-audit-dialog-body[data-v-531c2eb3]::-webkit-scrollbar{width:8px}.settlement-audit-dialog-body[data-v-531c2eb3]::-webkit-scrollbar-track{background:#f1f1f1;border-radius:4px}.settlement-audit-dialog-body[data-v-531c2eb3]::-webkit-scrollbar-thumb{background:#c1c1c1;border-radius:4px}.settlement-audit-dialog-body[data-v-531c2eb3]::-webkit-scrollbar-thumb:hover{background:#a1a1a1}.settlement-audit-dialog-footer[data-v-531c2eb3]{background:#fff;border-top:1px solid #e9ecef;display:flex;gap:10px;justify-content:flex-end;padding:20px}.export-options[data-v-531c2eb3]{align-items:center;display:flex;gap:0}.main-export-btn[data-v-531c2eb3]{border-bottom-right-radius:0;border-top-right-radius:0}.export-dropdown[data-v-531c2eb3]{position:relative}.dropdown-toggle[data-v-531c2eb3]{border-bottom-left-radius:0;border-left:none;border-top-left-radius:0;padding:10px 8px}.dropdown-menu[data-v-531c2eb3]{background:#fff;border:1px solid #ddd;border-radius:6px;bottom:100%;box-shadow:0 4px 6px rgba(0,0,0,.1);margin-bottom:5px;min-width:160px;position:absolute;right:0;z-index:1000}.dropdown-item[data-v-531c2eb3]{align-items:center;background:none;border:none;cursor:pointer;display:flex;font-size:14px;gap:8px;padding:8px 12px;text-align:left;transition:background-color .2s;width:100%}.dropdown-item[data-v-531c2eb3]:hover{background:#f8f9fa}.dropdown-item[data-v-531c2eb3]:first-child{border-top-left-radius:6px;border-top-right-radius:6px}.dropdown-item[data-v-531c2eb3]:last-child{border-bottom-left-radius:6px;border-bottom-right-radius:6px}.btn[data-v-531c2eb3]{align-items:center;border:none;border-radius:6px;cursor:pointer;display:inline-flex;font-size:14px;font-weight:500;gap:8px;padding:10px 20px;-webkit-text-decoration:none;text-decoration:none;transition:all .2s ease}.btn-primary[data-v-531c2eb3]{background:#28a745;color:#fff}.btn-primary[data-v-531c2eb3]:hover{background:#218838;transform:translateY(-1px)}.btn-outline-primary[data-v-531c2eb3]{background:#fff;border:1px solid #28a745;color:#28a745}.btn-outline-primary[data-v-531c2eb3]:hover{background:#28a745;color:#fff;transform:translateY(-1px)}.btn-secondary[data-v-531c2eb3]{background:#6c757d;color:#fff}.btn-secondary[data-v-531c2eb3]:hover{background:#5a6268;transform:translateY(-1px)}.btn[data-v-531c2eb3]:disabled{cursor:not-allowed;opacity:.6;transform:none}@media (max-width:768px){.settlement-audit-dialog[data-v-531c2eb3]{border-radius:0;height:100%;max-height:100vh;max-width:100%}.settlement-audit-dialog-header[data-v-531c2eb3]{padding:15px}.header-info h3[data-v-531c2eb3]{font-size:18px}.settlement-audit-dialog-footer[data-v-531c2eb3]{flex-direction:column;padding:15px}.btn[data-v-531c2eb3],.export-options[data-v-531c2eb3]{width:100%}.btn[data-v-531c2eb3]{justify-content:center}.main-export-btn[data-v-531c2eb3]{border-radius:6px;border-bottom-left-radius:0;border-bottom-right-radius:0}.dropdown-toggle[data-v-531c2eb3]{border-left:1px solid #28a745;border-radius:6px;border-top-left-radius:0;border-top-right-radius:0}.dropdown-menu[data-v-531c2eb3]{border:none;box-shadow:none;margin-bottom:0;position:static;width:100%}}@media (max-width:480px){.settlement-audit-dialog-overlay[data-v-531c2eb3]{padding:0}.settlement-audit-dialog-header[data-v-531c2eb3]{align-items:flex-start;flex-direction:column;gap:10px;position:relative}.close-btn[data-v-531c2eb3]{position:absolute;right:15px;top:15px}.header-info h3[data-v-531c2eb3]{font-size:16px}.settlement-subtitle[data-v-531c2eb3]{font-size:12px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5bfc32bd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(546);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5bfc32bd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5bfc32bd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5bfc32bd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_5bfc32bd_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".voucher-container[data-v-5bfc32bd]{background:#fff;margin:0 auto;max-width:900px;padding:40px}.voucher-header[data-v-5bfc32bd]{border-bottom:3px solid #a12f8d;margin-bottom:30px;padding-bottom:15px}.header-flex[data-v-5bfc32bd]{align-items:center;display:flex;gap:20px;justify-content:space-between}.header-left[data-v-5bfc32bd]{flex-shrink:0}.header-center[data-v-5bfc32bd]{flex:1;text-align:left}.header-right[data-v-5bfc32bd]{flex-shrink:0;text-align:right}.logo-placeholder[data-v-5bfc32bd]{align-items:center;border:2px dashed #ddd;border-radius:4px;display:flex;height:100px;justify-content:center;width:120px}.company-logo[data-v-5bfc32bd]{border-radius:4px;display:block;height:auto;max-height:100px;-o-object-fit:contain;object-fit:contain;width:120px}.company-name[data-v-5bfc32bd]{color:#a12f8d;font-size:24px;font-weight:700;margin:0 0 8px}.company-address[data-v-5bfc32bd],.company-contact[data-v-5bfc32bd]{color:#666;font-size:13px;margin:5px 0}.voucher-title h3[data-v-5bfc32bd]{color:#333;font-size:20px;margin:0 0 5px}.voucher-title h4[data-v-5bfc32bd]{color:#666;font-size:16px;margin:0}.voucher-info-grid[data-v-5bfc32bd]{display:grid;grid-template-columns:1fr 1fr;grid-gap:15px;background-color:#f9f9f9;border-radius:4px;gap:15px;margin:25px 0;padding:15px}.info-row[data-v-5bfc32bd]{display:flex;padding:5px 0}.label[data-v-5bfc32bd]{color:#333;font-weight:600;min-width:130px}.value[data-v-5bfc32bd]{color:#666}.voucher-table[data-v-5bfc32bd]{border-collapse:collapse;font-size:13px;margin:25px 0;width:100%}.voucher-table td[data-v-5bfc32bd],.voucher-table th[data-v-5bfc32bd]{border:1px solid #ddd;padding:10px}.voucher-table th[data-v-5bfc32bd]{background-color:#a12f8d;color:#fff;font-weight:600;text-align:left}.voucher-table tbody tr[data-v-5bfc32bd]:nth-child(2n){background-color:#f9f9f9}.voucher-table .text-center[data-v-5bfc32bd]{text-align:center}.voucher-table .text-right[data-v-5bfc32bd]{text-align:right}.total-row td[data-v-5bfc32bd]{background-color:#e8f5e9;font-size:14px;font-weight:700}.amount-words[data-v-5bfc32bd]{background-color:#f0f4ff;border-left:4px solid #a12f8d;font-size:14px;margin:20px 0;padding:15px}.voucher-description[data-v-5bfc32bd]{background-color:#fff9e6;border-radius:4px;font-size:13px;margin:20px 0;padding:15px}.signature-section[data-v-5bfc32bd]{display:flex;gap:40px;justify-content:space-between;margin-top:60px}.signature-box[data-v-5bfc32bd]{flex:1;text-align:center}.signature-line[data-v-5bfc32bd]{border-top:2px solid #333;margin:80px 10px 15px}.signature-label[data-v-5bfc32bd]{color:#333;font-size:13px;font-weight:600;margin:8px 0}.signature-name[data-v-5bfc32bd]{font-size:14px;font-weight:500;margin:5px 0}.signature-date[data-v-5bfc32bd]{color:#666;font-size:12px}@media print{.voucher-container[data-v-5bfc32bd]{padding:20px}.company-logo[data-v-5bfc32bd]{max-height:80px;width:100px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("462d05bb", content, true, context)
};
...
var vouchervue_type_template_id_5bfc32bd_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
...
// CONCATENATED MODULE: ./components/accounting/ap/settlement/voucher/index.vue?vue&type=template&id=5bfc32bd&scoped=true
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  vouchervue_type_template_id_5bfc32bd_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "5bfc32bd",
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/accounting/ap/settlement/audit/index.vue?vue&type=template&id=531c2eb3&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  ...
  }, [_vm._ssrNode("<div class=\"settlement-audit-dialog\" data-v-531c2eb3>", "</div>", [_vm._ssrNode("<div class=\"settlement-audit-dialog-header\" data-v-531c2eb3><div class=\"header-info\" data-v-531c2eb3><h3 data-v-531c2eb3><i class=\"fas fa-history\" data-v-531c2eb3></i>\n          ປະຫວັດການດຳເນີນງານການຊຳລະ\n        </h3> " + (_vm.settlementInfo ? "<p class=\"settlement-subtitle\" data-v-531c2eb3>" + _vm._ssrEscape("\n          ການຊຳລະ: " + _vm._s(_vm.settlementInfo.settlementId) + " - \n          " + _vm._s(_vm.formatCurrency(_vm.settlementInfo.paymentAmount)) + " - \n          " + _vm._s(_vm.formatDate(_vm.settlementInfo.settlementDate)) + "\n        ") + "</p>" : "<!---->") + "</div> <button type=\"button\" class=\"close-btn\" data-v-531c2eb3><i class=\"fas fa-times\" data-v-531c2eb3></i></button></div> "), _vm._ssrNode("<div class=\"settlement-audit-dialog-body\" data-v-531c2eb3>", "</div>", [_c('settlement-audit-viewer', {
  ...
  })], 1), _vm._ssrNode(" <div class=\"settlement-audit-dialog-footer\" data-v-531c2eb3><button type=\"button\" class=\"btn btn-secondary\" data-v-531c2eb3><i class=\"fas fa-times\" data-v-531c2eb3></i>\n        ປິດ\n      </button> <div class=\"export-options\" data-v-531c2eb3><button type=\"button\"" + _vm._ssrAttr("disabled", _vm.isExporting) + " class=\"btn btn-primary main-export-btn\" data-v-531c2eb3>" + (_vm.isExporting ? "<i class=\"fas fa-spinner fa-spin\" data-v-531c2eb3></i>" : "<i class=\"fas fa-download\" data-v-531c2eb3></i>") + _vm._ssrEscape("\n          " + _vm._s(_vm.isExporting ? 'ກຳລັງສົ່ງອອກ...' : 'ສົ່ງອອກ PDF') + "\n        ") + "</button> <div class=\"export-dropdown\" data-v-531c2eb3><button type=\"button\"" + _vm._ssrAttr("disabled", _vm.isExporting) + " class=\"btn btn-outline-primary dropdown-toggle\" data-v-531c2eb3><i class=\"fas fa-caret-down\" data-v-531c2eb3></i></button> " + (_vm.showExportOptions ? "<div class=\"dropdown-menu\" data-v-531c2eb3><button class=\"dropdown-item\" data-v-531c2eb3><i class=\"fas fa-code\" data-v-531c2eb3></i>\n              ສົ່ງອອກ JSON\n            </button> <button class=\"dropdown-item\" data-v-531c2eb3><i class=\"fas fa-table\" data-v-531c2eb3></i>\n              ສົ່ງອອກ CSV\n            </button> <button class=\"dropdown-item\" data-v-531c2eb3><i class=\"fas fa-print\" data-v-531c2eb3></i>\n              ພິມ\n            </button></div>" : "<!---->") + "</div></div></div>")], 2)]) : _vm._e();
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/accounting/ap/settlement/audit/index.vue?vue&type=template&id=531c2eb3&scoped=true
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_ca59d76c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(638);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_ca59d76c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_ca59d76c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_ca59d76c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_ca59d76c_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".form-control[data-v-ca59d76c]{border:1px solid #ddd;border-radius:4px;font-size:12px;height:32px;padding:6px 8px;transition:border-color .2s ease;width:100%}.form-control[data-v-ca59d76c]:focus{border-color:#17a2b8;box-shadow:0 0 0 2px rgba(23,162,184,.1);outline:none}.form-control[data-v-ca59d76c]:disabled{background-color:#f8f9fa;color:#6c757d}.form-control.is-invalid[data-v-ca59d76c]{border-color:#e74c3c}.form-control-xs[data-v-ca59d76c]{font-size:11px;height:28px;padding:4px 6px}select.form-control[data-v-ca59d76c],select.form-control-xs[data-v-ca59d76c]{-webkit-appearance:auto;-moz-appearance:auto;appearance:auto;background-color:#fff;cursor:pointer}select.form-control-xs[data-v-ca59d76c]:disabled,select.form-control[data-v-ca59d76c]:disabled{background-color:#e9ecef;cursor:not-allowed;opacity:.7}select.form-control-xs optgroup[data-v-ca59d76c]{background-color:#f8f9fa;color:#495057;font-style:normal;font-weight:600}select.form-control-xs option[data-v-ca59d76c]{font-size:11px;padding:4px 8px}.form-control-xs[data-v-ca59d76c]:focus,select.form-control-xs[data-v-ca59d76c]:focus{border-color:#17a2b8;box-shadow:0 0 0 2px rgba(23,162,184,.15);outline:none;z-index:2}.is-invalid[data-v-ca59d76c]{background-image:none}.is-invalid[data-v-ca59d76c],.is-invalid[data-v-ca59d76c]:focus{border-color:#dc3545!important}.is-invalid[data-v-ca59d76c]:focus{box-shadow:0 0 0 2px rgba(220,53,69,.25)}.invalid-feedback[data-v-ca59d76c]{color:#e74c3c;width:100%}.invalid-feedback[data-v-ca59d76c],.text-danger[data-v-ca59d76c]{display:block;font-size:10px;margin-top:2px}.text-danger[data-v-ca59d76c]{color:#dc3545!important}.text-truncate[data-v-ca59d76c]{display:inline-block;max-width:100%;overflow:hidden;text-overflow:ellipsis;vertical-align:middle;white-space:nowrap}.text-right[data-v-ca59d76c]{text-align:right!important}.text-center[data-v-ca59d76c]{text-align:center!important}.required[data-v-ca59d76c]{color:#e74c3c;font-weight:700}.modal-overlay[data-v-ca59d76c]{align-items:center;background-color:rgba(0,0,0,.7);justify-content:center;left:0;padding:0;position:fixed;top:0;z-index:1000}.modal-overlay[data-v-ca59d76c],.settlement-dialog[data-v-ca59d76c]{display:flex;height:100vh;width:100vw}.settlement-dialog[data-v-ca59d76c]{background:#fff;flex-direction:column;overflow:hidden}.dialog-header[data-v-ca59d76c]{align-items:center;background:linear-gradient(135deg,#a12f8d,#337555);border-bottom:1px solid #e9ecef;color:#fff;display:flex;justify-content:space-between;min-height:50px;padding:12px 20px}.dialog-header h4[data-v-ca59d76c]{font-size:16px;font-weight:600;margin:0}.header-actions[data-v-ca59d76c]{gap:8px}.audit-btn[data-v-ca59d76c],.header-actions[data-v-ca59d76c]{align-items:center;display:flex}.audit-btn[data-v-ca59d76c]{background:hsla(0,0%,100%,.2);border:none;border-radius:4px;color:#fff;cursor:pointer;font-size:12px;gap:4px;padding:6px 10px;transition:all .2s ease}.audit-btn[data-v-ca59d76c]:hover{background:hsla(0,0%,100%,.3)}.audit-text[data-v-ca59d76c]{font-size:11px}.close-btn[data-v-ca59d76c]{background:none;border:none;border-radius:50%;color:#fff;cursor:pointer;font-size:16px;padding:4px;transition:all .2s ease}.close-btn[data-v-ca59d76c]:hover{background:hsla(0,0%,100%,.2)}.dialog-body[data-v-ca59d76c]{flex:1;overflow-y:auto;padding:0}.form-section[data-v-ca59d76c]{background:#fafafa;border-bottom:1px solid #e9ecef;margin:0;padding:15px}.section-title[data-v-ca59d76c]{align-items:center;border-bottom:1px solid #17a2b8;color:#333;display:flex;font-size:14px;font-weight:600;gap:6px;margin-bottom:12px;padding-bottom:4px}.section-title i[data-v-ca59d76c]{color:#17a2b8;font-size:13px}.section-header[data-v-ca59d76c]{gap:10px;justify-content:space-between;margin-bottom:12px}.section-actions[data-v-ca59d76c],.section-header[data-v-ca59d76c]{align-items:center;display:flex;flex-wrap:wrap}.section-actions[data-v-ca59d76c]{gap:8px}.allocation-info[data-v-ca59d76c]{display:flex;font-size:11px;gap:12px}.info-item[data-v-ca59d76c]{background:#fff;border:1px solid #ddd;border-radius:4px;padding:4px 8px}.form-grid[data-v-ca59d76c]{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));grid-gap:10px;gap:10px}.span-2[data-v-ca59d76c]{grid-column:span 2}.form-group[data-v-ca59d76c]{margin-bottom:0}.form-group label[data-v-ca59d76c]{color:#333;display:block;font-size:12px;font-weight:500;margin-bottom:3px}.type-badge[data-v-ca59d76c]{border-radius:3px;display:inline-block;font-size:10px;font-weight:600;padding:3px 8px;text-transform:uppercase;white-space:nowrap}.type-badge.invoice[data-v-ca59d76c]{background:#e3f2fd;border:1px solid #90caf9;color:#1976d2}.type-badge.manual[data-v-ca59d76c]{background:#fff3e0;border:1px solid #ffb74d;color:#f57c00}.type-badge.mou[data-v-ca59d76c]{background:#e8f5e9;border:1px solid #81c784;color:#2e7d32}.no-invoices[data-v-ca59d76c]{background:#fff;border:2px dashed #ddd;border-radius:6px;color:#666;padding:30px 20px;text-align:center}.no-invoices i[data-v-ca59d76c]{font-size:32px;margin-bottom:10px;opacity:.5}.no-invoices p[data-v-ca59d76c]{font-size:14px;font-weight:600;margin:8px 0 15px}.action-buttons[data-v-ca59d76c]{display:flex;flex-wrap:wrap;gap:10px;justify-content:center}.settlement-lines[data-v-ca59d76c]{background:#fff;border:1px solid #e9ecef;border-radius:6px;overflow:hidden}.table-responsive[data-v-ca59d76c]{overflow-x:auto;width:100%;-webkit-overflow-scrolling:touch}.table[data-v-ca59d76c]{border-collapse:collapse;font-size:11px;margin:0;width:100%}.table th[data-v-ca59d76c]{background:#f8f9fa;border-bottom:2px solid #dee2e6;font-size:11px;font-weight:600;padding:8px 4px;text-align:center;white-space:nowrap}.table td[data-v-ca59d76c],.table th[data-v-ca59d76c]{vertical-align:middle}.table td[data-v-ca59d76c]{border-top:1px solid #dee2e6;padding:6px 4px}.table td input.form-control-xs[data-v-ca59d76c],.table td select.form-control-xs[data-v-ca59d76c]{min-width:80px;width:100%}.table td[data-v-ca59d76c]:nth-child(5),.table th[data-v-ca59d76c]:nth-child(5){min-width:200px}.line-number[data-v-ca59d76c]{color:#666;font-size:10px;font-weight:600;text-align:center}.allocation-summary[data-v-ca59d76c]{background:#f8f9fa;border-top:2px solid #dee2e6;padding:10px 15px}.totals-inline[data-v-ca59d76c]{flex-wrap:wrap;font-size:12px;font-weight:600;gap:10px;justify-content:flex-end}.total-item[data-v-ca59d76c],.totals-inline[data-v-ca59d76c]{align-items:center;display:flex}.total-item[data-v-ca59d76c]{gap:6px}.total-item strong[data-v-ca59d76c]{color:#28a745;font-size:14px}.btn[data-v-ca59d76c]{align-items:center;border:none;border-radius:4px;cursor:pointer;display:inline-flex;font-size:12px;font-weight:500;gap:4px;padding:6px 12px;transition:all .2s ease;white-space:nowrap}.btn-primary[data-v-ca59d76c]{background:#007bff;color:#fff}.btn-primary[data-v-ca59d76c]:hover:not(:disabled){background:#0056b3}.btn-secondary[data-v-ca59d76c]{background:#6c757d;color:#fff}.btn-secondary[data-v-ca59d76c]:hover:not(:disabled){background:#545b62}.btn-success[data-v-ca59d76c]{background:#28a745;color:#fff}.btn-success[data-v-ca59d76c]:hover:not(:disabled){background:#218838}.btn-info[data-v-ca59d76c]{background:#17a2b8;color:#fff}.btn-info[data-v-ca59d76c]:hover:not(:disabled){background:#138496}.btn-danger[data-v-ca59d76c]{background:#dc3545;color:#fff}.btn-danger[data-v-ca59d76c]:hover:not(:disabled){background:#c82333}.btn-sm[data-v-ca59d76c]{font-size:11px;padding:4px 8px}.btn-xs[data-v-ca59d76c]{align-items:center;border-radius:50%;display:flex;font-size:10px;height:24px;justify-content:center;padding:0;width:24px}.btn[data-v-ca59d76c]:hover:not(:disabled){box-shadow:0 2px 4px rgba(0,0,0,.1);opacity:.95;transform:translateY(-1px)}.btn[data-v-ca59d76c]:disabled{cursor:not-allowed;opacity:.6;transform:none}.dialog-footer[data-v-ca59d76c]{background:#f8f9fa;border-top:1px solid #e9ecef;min-height:56px;padding:12px 20px}.footer-actions[data-v-ca59d76c]{display:flex;gap:8px;justify-content:flex-end}@media (max-width:768px){.form-grid[data-v-ca59d76c]{grid-template-columns:1fr}.span-2[data-v-ca59d76c]{grid-column:span 1}.section-header[data-v-ca59d76c]{align-items:flex-start;flex-direction:column}.section-actions[data-v-ca59d76c]{width:100%}.allocation-info[data-v-ca59d76c]{flex-direction:column;gap:6px;width:100%}.totals-inline[data-v-ca59d76c]{align-items:flex-start;gap:6px}.footer-actions[data-v-ca59d76c],.totals-inline[data-v-ca59d76c]{flex-direction:column}.footer-actions .btn[data-v-ca59d76c]{justify-content:center;width:100%}.action-buttons[data-v-ca59d76c]{flex-direction:column}.action-buttons .btn[data-v-ca59d76c]{width:100%}.table-responsive[data-v-ca59d76c]{border:1px solid #dee2e6;border-radius:4px}.table[data-v-ca59d76c]{min-width:900px}.table td[data-v-ca59d76c]:nth-child(5),.table th[data-v-ca59d76c]:nth-child(5){min-width:180px}}@media (max-width:480px){.dialog-header[data-v-ca59d76c]{padding:10px 15px}.dialog-header h4[data-v-ca59d76c]{font-size:14px}.header-actions[data-v-ca59d76c]{gap:6px}.audit-text[data-v-ca59d76c]{display:none}.form-section[data-v-ca59d76c]{padding:12px}.dialog-footer[data-v-ca59d76c]{padding:10px 15px}.table td[data-v-ca59d76c]:nth-child(5),.table th[data-v-ca59d76c]:nth-child(5){min-width:150px}select.form-control-xs option[data-v-ca59d76c]{font-size:10px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/accounting/ap/settlement/index.vue?vue&type=template&id=ca59d76c&scoped=true
...
var settlementvue_type_template_id_ca59d76c_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _vm.visible ? _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"settlement-dialog\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<div class=\"dialog-header\" data-v-ca59d76c><h4 data-v-ca59d76c>" + _vm._ssrEscape(_vm._s(_vm.isEditMode ? 'ແກ້ໄຂການຊຳລະ' : 'ສ້າງການຊຳລະໃໝ່')) + "</h4> <div class=\"header-actions\" data-v-ca59d76c>" + (_vm.isEditMode ? "<button type=\"button\" title=\"ເບິ່ງປະຫວັດການດຳເນີນງານ\" class=\"audit-btn\" data-v-ca59d76c><i class=\"fas fa-history\" data-v-ca59d76c></i> <span class=\"audit-text\" data-v-ca59d76c>ປະຫວັດ</span></button>" : "<!---->") + " <button class=\"close-btn\" data-v-ca59d76c><i class=\"fas fa-times\" data-v-ca59d76c></i></button></div></div> "), _vm._ssrNode("<div class=\"dialog-body\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<form data-v-ca59d76c>", "</form>", [_vm._ssrNode("<div class=\"form-section\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<h5 class=\"section-title\" data-v-ca59d76c><i class=\"fas fa-credit-card\" data-v-ca59d76c></i>\n            ຂໍ້ມູນການຊຳລະ\n          </h5> "), _vm._ssrNode("<div class=\"form-grid\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<div class=\"form-group\" data-v-ca59d76c><label data-v-ca59d76c>ວັນທີຊຳລະ <span class=\"required\" data-v-ca59d76c>*</span></label> <input type=\"date\" required=\"required\"" + _vm._ssrAttr("value", _vm.form.settlementDate) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.settlementDate
  }) + " data-v-ca59d76c> " + (_vm.errors.settlementDate ? "<div class=\"invalid-feedback\" data-v-ca59d76c>" + _vm._ssrEscape("\n                " + _vm._s(_vm.errors.settlementDate) + "\n              ") + "</div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"form-group\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<label for=\"paymentMethodId\" class=\"required\" data-v-ca59d76c>ວິທີການຊຳລະ</label> "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "id": "paymentMethodId",
  ...
  })], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"form-group\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<label for=\"currencyId\" class=\"required\" data-v-ca59d76c>ສະກຸນເງິນ</label> "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "id": "currencyId",
  ...
  })], 2), _vm._ssrNode(" <div class=\"form-group\" data-v-ca59d76c><label for=\"exchangeRate\" class=\"required\" data-v-ca59d76c>\n                ອັດຕາແລກປ່ຽນ\n                " + (_vm.selectedCurrency ? "<span class=\"currency-info\" data-v-ca59d76c>" + _vm._ssrEscape("\n                  (" + _vm._s(_vm.selectedCurrency.code) + " ຕໍ່ LAK)\n                ") + "</span>" : "<!---->") + "</label> <input id=\"exchangeRate\" type=\"number\" step=\"0.0001\" min=\"0\" placeholder=\"1.0000\"" + _vm._ssrAttr("value", _vm.form.exchangeRate) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.exchangeRate
  }) + " data-v-ca59d76c> " + (_vm.errors.exchangeRate ? "<div class=\"invalid-feedback\" data-v-ca59d76c>" + _vm._ssrEscape("\n                " + _vm._s(_vm.errors.exchangeRate) + "\n              ") + "</div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"form-group\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<label for=\"bankAccountId\" data-v-ca59d76c>ບັນຊີທະນາຄານ</label> "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "id": "bankAccountId",
  ...
  })], 2), _vm._ssrNode(" <div class=\"form-group\" data-v-ca59d76c><label data-v-ca59d76c>ອ້າງອີງ</label> <input type=\"text\" maxlength=\"100\" placeholder=\"ຫມາຍເລກອ້າງອີງ\"" + _vm._ssrAttr("value", _vm.form.reference) + " class=\"form-control\" data-v-ca59d76c></div> <div class=\"form-group span-2\" data-v-ca59d76c><label data-v-ca59d76c>ຄຳອະທິບາຍ</label> <textarea rows=\"2\" placeholder=\"ຄຳອະທິບາຍການຊຳລະ\" class=\"form-control\" data-v-ca59d76c>" + _vm._ssrEscape(_vm._s(_vm.form.description)) + "</textarea></div>")], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"form-section\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<div class=\"section-header\" data-v-ca59d76c><h5 class=\"section-title\" data-v-ca59d76c><i class=\"fas fa-list\" data-v-ca59d76c></i>\n              ລາຍການຈັດສັນ\n            </h5> <div class=\"section-actions\" data-v-ca59d76c><button type=\"button\"" + _vm._ssrAttr("disabled", !_vm.canModifyAllocations) + " class=\"btn btn-info btn-sm\" data-v-ca59d76c><i class=\"fas fa-file-contract\" data-v-ca59d76c></i> ເພີ່ມຈາກ MOU\n              </button> <button type=\"button\"" + _vm._ssrAttr("disabled", !_vm.canModifyAllocations) + " class=\"btn btn-success btn-sm\" data-v-ca59d76c><i class=\"fas fa-plus\" data-v-ca59d76c></i> ເພີ່ມລາຍການ\n              </button> <button type=\"button\"" + _vm._ssrAttr("disabled", !_vm.canModifyAllocations) + " class=\"btn btn-primary btn-sm\" data-v-ca59d76c><i class=\"fas fa-file-invoice\" data-v-ca59d76c></i> ເລືອກຈາກໃບແຈ້ງໜີ້\n              </button> <div class=\"allocation-info\" data-v-ca59d76c><span class=\"info-item\" data-v-ca59d76c>\n                  ຈັດສັນ:\n                  <strong data-v-ca59d76c>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.totalAllocated))) + "</strong></span></div></div></div> "), _vm.settlementLines.length === 0 ? _vm._ssrNode("<div class=\"no-invoices\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<i class=\"fas fa-clipboard-list\" data-v-ca59d76c></i> <p data-v-ca59d76c>ຍັງບໍ່ມີລາຍການຈັດສັນ</p> <div class=\"action-buttons\" data-v-ca59d76c><button type=\"button\" class=\"btn btn-info btn-sm\" data-v-ca59d76c><i class=\"fas fa-file-contract\" data-v-ca59d76c></i> ເພີ່ມຈາກ MOU\n              </button> <button type=\"button\" class=\"btn btn-success btn-sm\" data-v-ca59d76c><i class=\"fas fa-plus-circle\" data-v-ca59d76c></i> ເພີ່ມລາຍການດ້ວຍມື\n              </button> <button type=\"button\" class=\"btn btn-primary btn-sm\" data-v-ca59d76c><i class=\"fas fa-file-invoice\" data-v-ca59d76c></i> ເລືອກຈາກໃບແຈ້ງໜີ້\n              </button></div>")], 2) : _vm._ssrNode("<div class=\"settlement-lines\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<div class=\"table-responsive\" data-v-ca59d76c>", "</div>", [_vm._ssrNode("<table class=\"table\" data-v-ca59d76c>", "</table>", [_vm._ssrNode("<thead data-v-ca59d76c><tr data-v-ca59d76c><th style=\"width: 20px\" data-v-ca59d76c>#</th> <th data-v-ca59d76c>ປະເພດ</th> <th data-v-ca59d76c>ເລກທີໃບແຈ້ງໜີ້</th> <th data-v-ca59d76c>" + _vm._ssrEscape(_vm._s(_vm.formLabel.vendor)) + "</th> <th data-v-ca59d76c>ລະຫັດການເງິນ <span class=\"required\" data-v-ca59d76c>*</span></th> <th data-v-ca59d76c>ຄຳອະທິບາຍ</th> <th data-v-ca59d76c>DR</th> <th data-v-ca59d76c>CR</th> <th class=\"text-right\" data-v-ca59d76c>ຈຳນວນເງິນ</th> <th class=\"text-center\" style=\"width: 40px\" data-v-ca59d76c>ລຶບ</th></tr></thead> "), _vm._ssrNode("<tbody data-v-ca59d76c>", "</tbody>", _vm._l(_vm.settlementLines, function (line, index) {
    var _line$agency, _line$agency2;
    return _vm._ssrNode("<tr data-v-ca59d76c>", "</tr>", [_vm._ssrNode("<td class=\"line-number\" data-v-ca59d76c>" + _vm._ssrEscape(_vm._s(index + 1)) + "</td> <td data-v-ca59d76c><span" + _vm._ssrClass(null, ['type-badge', line.type]) + " data-v-ca59d76c>" + _vm._ssrEscape("\n                        " + _vm._s(line.type === 'invoice' ? 'ໃບແຈ້ງໜີ້' : line.type === 'mou' ? 'MOU' : 'ດ້ວຍມື') + "\n                      ") + "</span></td> <td data-v-ca59d76c>" + (line.type === 'manual' ? "<input type=\"text\" placeholder=\"ເລກທີໃບແຈ້ງໜີ້\"" + _vm._ssrAttr("disabled", !_vm.canModifyAllocations) + _vm._ssrAttr("value", line.invoiceNumber) + " class=\"form-control form-control-xs\" data-v-ca59d76c>" : "<span" + _vm._ssrAttr("title", line.invoiceNumber) + " class=\"text-truncate\" data-v-ca59d76c>" + _vm._ssrEscape("\n                        " + _vm._s(line.invoiceNumber || '-') + "\n                      ") + "</span>") + "</td> "), _vm._ssrNode("<td data-v-ca59d76c>", "</td>", [line.type === 'manual' ? _c(VAutocomplete["a" /* default */], {
    ...
    }), _vm._ssrNode(" " + (!line.txnId && _vm.errors.settlementLines ? "<small class=\"text-danger d-block mt-1\" data-v-ca59d76c>\n                        ກະລຸນາເລືອກລະຫັດການເງິນ\n                      </small>" : "<!---->"))], 2), _vm._ssrNode(" <td data-v-ca59d76c><input type=\"text\" placeholder=\"ຄຳອະທິບາຍ\"" + _vm._ssrAttr("disabled", !_vm.canModifyAllocations) + _vm._ssrAttr("value", line.description) + " class=\"form-control form-control-xs\" data-v-ca59d76c></td> "), _vm._ssrNode("<td data-v-ca59d76c>", "</td>", [_c(VAutocomplete["a" /* default */], {
      staticClass: "mt-0",
      attrs: {
    ...
    }), _vm._ssrNode(" " + (_vm.errors[`line_${index}_DRglAccountId`] ? "<small class=\"text-danger d-block mt-1\" data-v-ca59d76c>" + _vm._ssrEscape("\n                        " + _vm._s(_vm.errors[`line_${index}_DRglAccountId`]) + "\n                      ") + "</small>" : "<!---->"))], 2), _vm._ssrNode(" "), _vm._ssrNode("<td data-v-ca59d76c>", "</td>", [_c(VAutocomplete["a" /* default */], {
      staticClass: "mt-0",
      attrs: {
        "items": _vm.glAccounts,
        "item-value": "id",
    ...
    }), _vm._ssrNode(" " + (_vm.errors[`line_${index}_CRglAccountId`] ? "<small class=\"text-danger d-block mt-1\" data-v-ca59d76c>" + _vm._ssrEscape("\n                        " + _vm._s(_vm.errors[`line_${index}_CRglAccountId`]) + "\n                      ") + "</small>" : "<!---->"))], 2), _vm._ssrNode(" <td data-v-ca59d76c><input type=\"number\" step=\"0.01\" min=\"0\"" + _vm._ssrAttr("disabled", !_vm.canModifyAllocations) + _vm._ssrAttr("value", line.amount) + " class=\"form-control form-control-xs text-right\" data-v-ca59d76c></td> <td class=\"text-center\" data-v-ca59d76c><button type=\"button\"" + _vm._ssrAttr("disabled", !_vm.canModifyAllocations) + " title=\"ລຶບລາຍການ\" class=\"btn btn-xs btn-danger\" data-v-ca59d76c><i class=\"fas fa-trash\" data-v-ca59d76c></i></button></td>")], 2);
  }), 0)], 2)]), _vm._ssrNode(" <div class=\"allocation-summary\" data-v-ca59d76c><div class=\"totals-inline\" data-v-ca59d76c><span class=\"total-item\" data-v-ca59d76c>\n                  ລວມຈຳນວນເງິນຊຳລະ:\n                  <strong data-v-ca59d76c>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.totalAllocated))) + "</strong></span></div></div>")], 2)], 2), _vm._ssrNode(" " + (_vm.showApprovalSection ? "<div class=\"form-section\" data-v-ca59d76c><h5 class=\"section-title\" data-v-ca59d76c><i class=\"fas fa-check-circle\" data-v-ca59d76c></i>\n            ການອະນຸມັດ\n          </h5> <div class=\"form-grid\" data-v-ca59d76c><div class=\"form-group\" data-v-ca59d76c><label data-v-ca59d76c>ຜູ້ອະນຸມັດ</label> <input type=\"text\" disabled=\"disabled\"" + _vm._ssrAttr("value", _vm.checkerName) + " class=\"form-control\" data-v-ca59d76c></div> <div class=\"form-group\" data-v-ca59d76c><label data-v-ca59d76c>ໝາຍເຫດການອະນຸມັດ</label> <textarea rows=\"2\" placeholder=\"ໝາຍເຫດການອະນຸມັດ\"" + _vm._ssrAttr("disabled", !_vm.canApprove) + " class=\"form-control\" data-v-ca59d76c>" + _vm._ssrEscape(_vm._s(_vm.form.approvalNote)) + "</textarea></div></div></div>" : "<!---->"))], 2)]), _vm._ssrNode(" <div class=\"dialog-footer\" data-v-ca59d76c><div class=\"footer-actions\" data-v-ca59d76c><button type=\"button\" class=\"btn btn-secondary\" data-v-ca59d76c><i class=\"fas fa-times\" data-v-ca59d76c></i> ຍົກເລີກ\n        </button> " + (_vm.canApprove && _vm.form.status === 'pending' ? "<button type=\"button\"" + _vm._ssrAttr("disabled", _vm.isSubmitting) + " class=\"btn btn-success\" data-v-ca59d76c><i class=\"fas fa-check\" data-v-ca59d76c></i> ອະນຸມັດ\n        </button>" : "<!---->") + " " + (_vm.canComplete && ['pending', 'approved'].includes(_vm.form.status) ? "<button type=\"button\"" + _vm._ssrAttr("disabled", _vm.isSubmitting) + " class=\"btn btn-info\" data-v-ca59d76c><i class=\"fas fa-check-circle\" data-v-ca59d76c></i> ສຳເລັດ\n        </button>" : "<!---->") + " <button type=\"submit\"" + _vm._ssrAttr("disabled", _vm.isSubmitting || !_vm.canModify) + " class=\"btn btn-primary\" data-v-ca59d76c><i class=\"fas fa-save\" data-v-ca59d76c></i>" + _vm._ssrEscape("\n          " + _vm._s(_vm.isSubmitting ? 'ກຳລັງບັນທຶກ...' : _vm.isEditMode ? 'ອັບເດດ' : 'ບັນທຶກ') + "\n        ") + "</button> " + (_vm.isEditMode ? "<button type=\"button\" class=\"btn btn-info\" data-v-ca59d76c><i class=\"fas fa-print\" data-v-ca59d76c></i> ພິມໃບສຳຄັນ\n        </button>" : "<!---->") + "</div></div>")], 2), _vm._ssrNode(" "), _c(VDialog["a" /* default */], {
    attrs: {
      "max-width": "900px",
      "persistent": "",
      "scrollable": ""
...
// CONCATENATED MODULE: ./components/accounting/ap/settlement/index.vue?vue&type=template&id=ca59d76c&scoped=true
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  settlementvue_type_template_id_ca59d76c_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "ca59d76c",
