...
var ap_invoice = __webpack_require__(978);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(URL) {/* harmony import */ var _components_accounting_ap_invoice_audit_view__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(599);
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("42abccb2", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25e8a7cc_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(656);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25e8a7cc_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25e8a7cc_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25e8a7cc_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_25e8a7cc_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".modal-overlay[data-v-25e8a7cc]{align-items:center;background-color:rgba(0,0,0,.7);justify-content:center;left:0;padding:0;position:fixed;top:0;z-index:1050}.enhanced-dialog[data-v-25e8a7cc],.modal-overlay[data-v-25e8a7cc]{display:flex;height:100vh;width:100vw}.enhanced-dialog[data-v-25e8a7cc]{background:#fff;flex-direction:column;overflow:hidden}.modal-header[data-v-25e8a7cc]{background:linear-gradient(135deg,primary,secondary);border-bottom:1px solid #e9ecef;color:#fff;justify-content:space-between;min-height:50px;padding:12px 20px}.modal-header[data-v-25e8a7cc],.modal-title[data-v-25e8a7cc]{align-items:center;display:flex}.modal-title[data-v-25e8a7cc]{font-size:16px;font-weight:600;gap:8px;margin:0}.close-button[data-v-25e8a7cc]{background:none;border:none;border-radius:4px;color:#fff;cursor:pointer;font-size:18px;padding:4px;transition:background .2s}.close-button[data-v-25e8a7cc]:hover{background:hsla(0,0%,100%,.2)}.modal-body[data-v-25e8a7cc]{flex:1;overflow-y:auto}.loading-state[data-v-25e8a7cc],.modal-body[data-v-25e8a7cc]{display:flex;flex-direction:column}.loading-state[data-v-25e8a7cc]{align-items:center;color:#666;justify-content:center;padding:30px}.spinner[data-v-25e8a7cc]{animation:spin-25e8a7cc 1s linear infinite;border:3px solid #f3f3f3;border-radius:50%;border-top-color:#3498db;height:30px;margin-bottom:10px;width:30px}@keyframes spin-25e8a7cc{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}.invoice-form[data-v-25e8a7cc]{display:flex;flex:1;flex-direction:column}.form-section[data-v-25e8a7cc]{border-bottom:1px solid #f0f0f0;padding:15px 20px}.section-header[data-v-25e8a7cc]{justify-content:space-between;margin-bottom:12px}.section-header[data-v-25e8a7cc],.section-title[data-v-25e8a7cc]{align-items:center;display:flex}.section-title[data-v-25e8a7cc]{color:#333;font-size:14px;font-weight:600;gap:8px;margin:0}.section-title i[data-v-25e8a7cc]{color:#667eea;font-size:13px}.line-count[data-v-25e8a7cc]{background:#667eea;border-radius:10px;color:#fff;font-size:11px;margin-left:4px;min-width:20px;padding:2px 8px;text-align:center}.add-line-actions[data-v-25e8a7cc]{align-items:center;display:flex;gap:6px}.form-grid[data-v-25e8a7cc]{display:grid;grid-template-columns:repeat(auto-fit,minmax(250px,1fr));grid-gap:12px;gap:12px;margin-top:12px}.span-2[data-v-25e8a7cc]{grid-column:span 2}.form-group[data-v-25e8a7cc]{margin-bottom:0}.form-group label[data-v-25e8a7cc]{color:#333;display:block;font-size:12px;font-weight:500;margin-bottom:3px}.form-group label.required[data-v-25e8a7cc]:after{color:#e74c3c;content:\" *\"}.form-control[data-v-25e8a7cc]{border:1px solid #ddd;border-radius:4px;font-size:12px;height:32px;padding:6px 8px;transition:border-color .2s,box-shadow .2s;width:100%}.form-control[data-v-25e8a7cc]:focus{border-color:#667eea;box-shadow:0 0 0 2px rgba(102,126,234,.1);outline:none}.form-control.is-invalid[data-v-25e8a7cc]{border-color:#e74c3c;box-shadow:0 0 0 2px rgba(231,76,60,.1)}.form-control-xs[data-v-25e8a7cc]{font-size:11px;height:28px;padding:4px 6px}.invalid-feedback[data-v-25e8a7cc]{color:#e74c3c;display:block;font-size:10px;margin-top:2px;width:100%}.currency-info[data-v-25e8a7cc]{color:#666;font-size:10px;font-weight:400}.exchange-display[data-v-25e8a7cc]{background:#f8f9fa;border:1px solid #e9ecef;border-radius:4px;margin-top:10px;padding:8px}.exchange-amount[data-v-25e8a7cc]{align-items:center;display:flex;font-size:12px;font-weight:600;gap:8px;justify-content:center}.foreign-amount[data-v-25e8a7cc]{color:#667eea}.exchange-arrow[data-v-25e8a7cc]{color:#28a745;font-size:10px}.local-amount[data-v-25e8a7cc]{color:#28a745}.empty-line-state[data-v-25e8a7cc]{background:#f8f9fa;border:2px dashed #dee2e6;border-radius:6px;margin-top:12px;padding:30px 20px;text-align:center}.empty-content i[data-v-25e8a7cc]{color:#dee2e6;font-size:40px;margin-bottom:12px}.empty-content h4[data-v-25e8a7cc]{color:#666;font-size:15px;margin-bottom:8px}.line-items-table-container[data-v-25e8a7cc]{border:1px solid #e9ecef;border-radius:6px;margin-top:12px;max-height:400px;overflow:hidden;overflow-y:auto}.line-items-table .table[data-v-25e8a7cc]{border-collapse:collapse;font-size:11px;margin:0;width:100%}.line-items-table .table th[data-v-25e8a7cc]{background:#f8f9fa;border-bottom:1px solid #dee2e6;font-size:10px;font-weight:600;padding:6px 4px;position:sticky;text-align:center;top:0;white-space:nowrap;z-index:10}.line-items-table .table td[data-v-25e8a7cc]{border-top:1px solid #dee2e6;padding:4px;vertical-align:middle}.line-number[data-v-25e8a7cc]{color:#666;text-align:center}.line-number[data-v-25e8a7cc],.line-total[data-v-25e8a7cc]{font-size:10px;font-weight:600}.line-total[data-v-25e8a7cc]{color:#333;text-align:right}.line-row[data-v-25e8a7cc]{transition:background-color .2s}.line-row[data-v-25e8a7cc]:hover{background-color:rgba(102,126,234,.05)}.amount-summary[data-v-25e8a7cc]{background:#f8f9fa;border-bottom:1px solid #f0f0f0;border-radius:0;border-top:2px solid #667eea;padding:12px 20px}.totals-grid[data-v-25e8a7cc]{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));grid-gap:8px;gap:8px}.total-item[data-v-25e8a7cc]{align-items:center;display:flex;font-size:12px;justify-content:space-between;padding:4px 0}.total-item.grand-total[data-v-25e8a7cc]{border-top:1px solid #667eea;font-size:13px;font-weight:600;grid-column:1/-1;margin-top:4px;padding-top:6px}.total-item .amount[data-v-25e8a7cc]{color:#333;font-weight:600}.total-item .amount.discount[data-v-25e8a7cc]{color:#e67e22}.total-item .amount.local[data-v-25e8a7cc]{color:#28a745}.audit-trail-compact[data-v-25e8a7cc]{background:#f8f9fa;border-bottom:1px solid #f0f0f0;border-radius:0;padding:12px 20px}.audit-header[data-v-25e8a7cc]{align-items:center;display:flex;justify-content:space-between;margin-bottom:10px}.audit-header h5[data-v-25e8a7cc]{color:#333;font-size:13px;font-weight:600;margin:0}.btn-view-audit[data-v-25e8a7cc]{align-items:center;background:#667eea;border:none;border-radius:4px;color:#fff;cursor:pointer;display:flex;font-size:11px;gap:4px;padding:4px 8px}.btn-view-audit[data-v-25e8a7cc]:hover{background:#5a6fd8}.audit-summary[data-v-25e8a7cc]{display:flex;flex-direction:column;gap:6px}.audit-item[data-v-25e8a7cc]{align-items:center;color:#666;display:flex;font-size:11px;gap:6px}.audit-item i[data-v-25e8a7cc]{color:#667eea;width:12px}.status-badge-container[data-v-25e8a7cc]{text-align:right}.status-badge[data-v-25e8a7cc]{border-radius:10px;font-size:10px;font-weight:600;padding:2px 6px;text-transform:uppercase}.status-badge.status-draft[data-v-25e8a7cc]{background:#e9ecef;color:#6c757d}.status-badge.status-pending[data-v-25e8a7cc]{background:#fff3cd;color:#856404}.status-badge.status-approved[data-v-25e8a7cc]{background:#d1ecf1;color:#0c5460}.btn[data-v-25e8a7cc]{align-items:center;border:none;border-radius:4px;cursor:pointer;display:inline-flex;font-size:12px;font-weight:500;gap:4px;padding:6px 12px;transition:all .2s ease}.btn-primary[data-v-25e8a7cc]{background:#007bff;color:#fff}.btn-secondary[data-v-25e8a7cc]{background:#6c757d;color:#fff}.btn-danger[data-v-25e8a7cc]{background:#dc3545;color:#fff}.btn[data-v-25e8a7cc]:hover:not(:disabled){opacity:.9;transform:translateY(-1px)}.btn[data-v-25e8a7cc]:disabled{cursor:not-allowed;opacity:.6;transform:none}.btn-sm[data-v-25e8a7cc]{font-size:11px;padding:5px 10px}.btn-xs[data-v-25e8a7cc]{align-items:center;border-radius:50%;display:flex;font-size:10px;height:24px;justify-content:center;padding:0;width:24px}.modal-footer[data-v-25e8a7cc]{background:#f8f9fa;border-top:1px solid #e9ecef;min-height:56px;padding:12px 20px}.footer-actions[data-v-25e8a7cc]{display:flex;gap:8px;justify-content:flex-end}@media (max-width:768px){.form-grid[data-v-25e8a7cc]{grid-template-columns:1fr}.span-2[data-v-25e8a7cc]{grid-column:span 1}.totals-grid[data-v-25e8a7cc]{grid-template-columns:1fr}.section-header[data-v-25e8a7cc]{align-items:flex-start;flex-direction:column;gap:8px}.add-line-actions[data-v-25e8a7cc]{justify-content:flex-start;width:100%}.line-items-table-container[data-v-25e8a7cc]{overflow-x:auto}.line-items-table .table[data-v-25e8a7cc]{min-width:700px}.footer-actions[data-v-25e8a7cc]{flex-direction:column}.footer-actions .btn[data-v-25e8a7cc]{justify-content:center;width:100%}}@media (max-width:480px){.modal-header[data-v-25e8a7cc]{padding:10px 15px}.modal-title[data-v-25e8a7cc]{font-size:14px}.form-section[data-v-25e8a7cc]{padding:12px 15px}.amount-summary[data-v-25e8a7cc],.audit-trail-compact[data-v-25e8a7cc],.modal-footer[data-v-25e8a7cc]{padding:10px 15px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/accounting/ap/invoice/index.vue?vue&type=template&id=25e8a7cc&scoped=true




var invoicevue_type_template_id_25e8a7cc_scoped_true_render = function render() {
  ...
  return _vm.visible ? _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"enhanced-dialog\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<div class=\"modal-header\" data-v-25e8a7cc><h4 class=\"modal-title\" data-v-25e8a7cc><i class=\"fas fa-file-invoice\" data-v-25e8a7cc></i>" + _vm._ssrEscape("\n        " + _vm._s(_vm.isEdit ? 'ແກ້ໄຂໃບແຈ້ງໜີ້' : 'ເພີ່ມໃບແຈ້ງໜີ້ໃໝ່') + "\n      ") + "</h4> <button type=\"button\" class=\"close-button\" data-v-25e8a7cc><i class=\"fas fa-times\" data-v-25e8a7cc></i></button></div> "), _vm._ssrNode("<div class=\"modal-body\" data-v-25e8a7cc>", "</div>", [_vm.formLoading ? _vm._ssrNode("<div class=\"loading-state\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<div class=\"spinner\" data-v-25e8a7cc></div> <p data-v-25e8a7cc>ກຳລັງໂຫຼດຂໍ້ມູນ...</p>")], 2) : _vm._ssrNode("<div class=\"invoice-form\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<form data-v-25e8a7cc>", "</form>", [_vm._ssrNode("<div class=\"form-section\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<h5 class=\"section-title\" data-v-25e8a7cc><i class=\"fas fa-info-circle\" data-v-25e8a7cc></i>\n              ຂໍ້ມູນພື້ນຖານ\n            </h5> "), _vm._ssrNode("<div class=\"form-grid\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<div class=\"form-group\" data-v-25e8a7cc><label for=\"invoiceDate\" class=\"required\" data-v-25e8a7cc>ວັນທີໃບແຈ້ງໜີ້</label> <input id=\"invoiceDate\" type=\"date\"" + _vm._ssrAttr("value", _vm.form.invoiceDate) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.invoiceDate
  }) + " data-v-25e8a7cc> " + (_vm.errors.invoiceDate ? "<div class=\"invalid-feedback\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.errors.invoiceDate) + "\n                ") + "</div>" : "<!---->") + "</div> <div class=\"form-group\" data-v-25e8a7cc><label for=\"invoiceNumber\" class=\"required\" data-v-25e8a7cc>ເລກທີໃບແຈ້ງໜີ້</label> <input id=\"invoiceNumber\" type=\"text\" placeholder=\"ເຊັ່ນ: INV-2025-001\"" + _vm._ssrAttr("readonly", _vm.isEdit) + _vm._ssrAttr("value", _vm.form.invoiceNumber) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.invoiceNumber
  }) + " data-v-25e8a7cc> " + (_vm.errors.invoiceNumber ? "<div class=\"invalid-feedback\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.errors.invoiceNumber) + "\n                ") + "</div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"form-group\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<label for=\"agencyId\" class=\"required\" data-v-25e8a7cc>ກະຊວງ</label> "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "id": "agencyId",
      "items": _vm.agencies,
      "item-value": "id",
  ...
  })], 2), _vm._ssrNode(" <div class=\"form-group\" data-v-25e8a7cc><label for=\"vendorInvoiceNumber\" data-v-25e8a7cc>ເລກທີໃບແຈ້ງໜີ້ຜູ້ຂາຍ</label> <input id=\"vendorInvoiceNumber\" type=\"text\" placeholder=\"ເລກທີໃບແຈ້ງໜີ້ຂອງຜູ້ຂາຍ\"" + _vm._ssrAttr("value", _vm.form.vendorInvoiceNumber) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.vendorInvoiceNumber
  }) + " data-v-25e8a7cc> " + (_vm.errors.vendorInvoiceNumber ? "<div class=\"invalid-feedback\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.errors.vendorInvoiceNumber) + "\n                ") + "</div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"form-group\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<label for=\"currencyId\" class=\"required\" data-v-25e8a7cc>ສະກຸນເງິນ</label> "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "id": "currencyId",
  ...
  })], 2), _vm._ssrNode(" <div class=\"form-group\" data-v-25e8a7cc><label for=\"exchangeRate\" class=\"required\" data-v-25e8a7cc>\n                  ອັດຕາແລກປ່ຽນ\n                  " + (_vm.selectedCurrency ? "<span class=\"currency-info\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                    (" + _vm._s(_vm.selectedCurrency.code) + " ຕໍ່ LAK)\n                  ") + "</span>" : "<!---->") + "</label> <input id=\"exchangeRate\" type=\"number\" step=\"0.0001\" min=\"0\" placeholder=\"1.0000\"" + _vm._ssrAttr("value", _vm.form.exchangeRate) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.exchangeRate
  }) + " data-v-25e8a7cc> " + (_vm.errors.exchangeRate ? "<div class=\"invalid-feedback\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.errors.exchangeRate) + "\n                ") + "</div>" : "<!---->") + "</div> <div class=\"form-group\" data-v-25e8a7cc><label for=\"dueDate\" data-v-25e8a7cc>ວັນທີຄົບກຳນົດ</label> <input id=\"dueDate\" type=\"date\"" + _vm._ssrAttr("value", _vm.form.dueDate) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.dueDate
  }) + " data-v-25e8a7cc> " + (_vm.errors.dueDate ? "<div class=\"invalid-feedback\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.errors.dueDate) + "\n                ") + "</div>" : "<!---->") + "</div> <div class=\"form-group span-2\" data-v-25e8a7cc><label for=\"description\" data-v-25e8a7cc>ຄຳອະທິບາຍ</label> <textarea id=\"description\" rows=\"2\" placeholder=\"ລາຍລະອຽດກ່ຽວກັບໃບແຈ້ງໜີ້...\" class=\"form-control\" data-v-25e8a7cc>" + _vm._ssrEscape(_vm._s(_vm.form.description)) + "</textarea></div>")], 2), _vm._ssrNode(" " + (_vm.selectedCurrency && _vm.form.exchangeRate ? "<div class=\"exchange-display\" data-v-25e8a7cc><div class=\"exchange-amount\" data-v-25e8a7cc><span class=\"foreign-amount\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.formatCurrency(_vm.calculatedTotal, ((_vm$selectedCurrency = _vm.selectedCurrency) === null || _vm$selectedCurrency === void 0 ? void 0 : _vm$selectedCurrency.code) || 'USD')) + "\n                ") + "</span> <i class=\"fas fa-arrow-right exchange-arrow\" data-v-25e8a7cc></i> <span class=\"local-amount\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.formatCurrency(_vm.calculatedTotal * parseFloat(_vm.form.exchangeRate || 1), 'LAK')) + "\n                ") + "</span></div></div>" : "<!---->") + " " + (_vm.isEdit ? "<div class=\"form-group\" data-v-25e8a7cc><label for=\"reason\" class=\"required\" data-v-25e8a7cc>ເຫດຜົນຂອງການແກ້ໄຂ</label> <input id=\"reason\" type=\"text\" placeholder=\"ລະບຸເຫດຜົນຂອງການແກ້ໄຂ...\"" + _vm._ssrAttr("value", _vm.form.reason) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.reason
  }) + " data-v-25e8a7cc> " + (_vm.errors.reason ? "<div class=\"invalid-feedback\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                " + _vm._s(_vm.errors.reason) + "\n              ") + "</div>" : "<!---->") + "</div>" : "<!---->"))], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"form-section\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<div class=\"section-header\" data-v-25e8a7cc><h5 class=\"section-title\" data-v-25e8a7cc><i class=\"fas fa-list\" data-v-25e8a7cc></i>\n                ລາຍການສິນຄ້າ\n                " + (_vm.lineItems.length > 0 ? "<span class=\"line-count\" data-v-25e8a7cc>" + _vm._ssrEscape(_vm._s(_vm.lineItems.length)) + "</span>" : "<!---->") + "</h5> <div class=\"add-line-actions\" data-v-25e8a7cc><button type=\"button\" class=\"btn btn-primary btn-sm\" data-v-25e8a7cc><i class=\"fas fa-plus\" data-v-25e8a7cc></i>\n                  ເພີ່ມລາຍການ\n                </button> <button type=\"button\" class=\"btn btn-secondary btn-xs\" data-v-25e8a7cc>\n                  +3\n                </button> <button type=\"button\" class=\"btn btn-secondary btn-xs\" data-v-25e8a7cc>\n                  +5\n                </button></div></div> "), _vm.lineItems.length === 0 ? _vm._ssrNode("<div class=\"empty-line-state\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<div class=\"empty-content\" data-v-25e8a7cc><i class=\"fas fa-shopping-cart\" data-v-25e8a7cc></i> <h4 data-v-25e8a7cc>ຍັງບໍ່ມີລາຍການສິນຄ້າ</h4> <button type=\"button\" class=\"btn btn-primary\" data-v-25e8a7cc><i class=\"fas fa-plus-circle\" data-v-25e8a7cc></i>\n                  ເພີ່ມລາຍການທຳອິດ\n                </button></div>")], 2) : _vm._ssrNode("<div class=\"line-items-table-container\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<div class=\"line-items-table\" data-v-25e8a7cc>", "</div>", [_vm._ssrNode("<table class=\"table\" data-v-25e8a7cc>", "</table>", [_vm._ssrNode("<thead data-v-25e8a7cc><tr data-v-25e8a7cc><th style=\"width: 30px\" data-v-25e8a7cc>#</th> <th style=\"width: 140px\" data-v-25e8a7cc>ລາຍລະອຽດ *</th> <th style=\"width: 140px\" data-v-25e8a7cc>ລະຫັດການເງິນ</th> <th style=\"width: 60px\" data-v-25e8a7cc>ຈຳນວນ *</th> <th style=\"width: 70px\" data-v-25e8a7cc>ລາຄາ *</th> <th style=\"width: 80px\" data-v-25e8a7cc>ລວມ</th> <th style=\"width: 40px\" data-v-25e8a7cc>ລຶບ</th></tr></thead> "), _vm._ssrNode("<tbody data-v-25e8a7cc>", "</tbody>", _vm._l(_vm.lineItems, function (line, index) {
    var _vm$selectedCurrency2;
    return _vm._ssrNode("<tr class=\"line-row\" data-v-25e8a7cc>", "</tr>", [_vm._ssrNode("<td class=\"line-number\" data-v-25e8a7cc>" + _vm._ssrEscape(_vm._s(index + 1)) + "</td> <td data-v-25e8a7cc><input type=\"text\" placeholder=\"ລາຍລະອຽດ...\"" + _vm._ssrAttr("value", line.description) + _vm._ssrClass("form-control form-control-xs", {
      'is-invalid': _vm.errors[`line_${index}_description`]
    }) + " data-v-25e8a7cc></td> "), _vm._ssrNode("<td data-v-25e8a7cc>", "</td>", [_c(VAutocomplete["a" /* default */], {
      staticClass: "mt-0",
      attrs: {
    ...
    }), _vm._ssrNode(" " + (!line.txnId && _vm.errors.settlementLines ? "<small class=\"text-danger d-block mt-1\" data-v-25e8a7cc>\n                          ກະລຸນາເລືອກລະຫັດການເງິນ\n                        </small>" : "<!---->"))], 2), _vm._ssrNode(" <td data-v-25e8a7cc><input type=\"number\" step=\"0.001\" min=\"0\"" + _vm._ssrAttr("value", line.quantity) + _vm._ssrClass("form-control form-control-xs", {
      'is-invalid': _vm.errors[`line_${index}_quantity`]
    }) + " data-v-25e8a7cc></td> <td data-v-25e8a7cc><input type=\"number\" step=\"0.01\" min=\"0\"" + _vm._ssrAttr("value", line.unitPrice) + _vm._ssrClass("form-control form-control-xs", {
      'is-invalid': _vm.errors[`line_${index}_unitPrice`]
    }) + " data-v-25e8a7cc></td> <td class=\"line-total\" data-v-25e8a7cc>" + _vm._ssrEscape("\n                        " + _vm._s(_vm.formatCurrency(line.lineTotal || 0, (_vm$selectedCurrency2 = _vm.selectedCurrency) === null || _vm$selectedCurrency2 === void 0 ? void 0 : _vm$selectedCurrency2.code)) + "\n                      ") + "</td> <td data-v-25e8a7cc><button type=\"button\" title=\"ລຶບ\" class=\"btn btn-xs btn-danger\" data-v-25e8a7cc><i class=\"fas fa-trash\" data-v-25e8a7cc></i></button></td>")], 2);
  }), 0)], 2)])])], 2), _vm._ssrNode(" <div class=\"amount-summary\" data-v-25e8a7cc><div class=\"totals-grid\" data-v-25e8a7cc><div class=\"total-item\" data-v-25e8a7cc><span data-v-25e8a7cc>ລວມຍ່ອຍ:</span> <span class=\"amount\" data-v-25e8a7cc>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.calculatedSubtotal, (_vm$selectedCurrency3 = _vm.selectedCurrency) === null || _vm$selectedCurrency3 === void 0 ? void 0 : _vm$selectedCurrency3.code))) + "</span></div> <div class=\"total-item\" data-v-25e8a7cc><span data-v-25e8a7cc>ສ່ວນຫຼຸດ:</span> <span class=\"amount discount\" data-v-25e8a7cc>" + _vm._ssrEscape("-" + _vm._s(_vm.formatCurrency(_vm.calculatedDiscount, (_vm$selectedCurrency4 = _vm.selectedCurrency) === null || _vm$selectedCurrency4 === void 0 ? void 0 : _vm$selectedCurrency4.code))) + "</span></div> <div class=\"total-item\" data-v-25e8a7cc><span data-v-25e8a7cc>ພາສີ:</span> <span class=\"amount\" data-v-25e8a7cc>" + _vm._ssrEscape("+" + _vm._s(_vm.formatCurrency(_vm.calculatedTax, (_vm$selectedCurrency5 = _vm.selectedCurrency) === null || _vm$selectedCurrency5 === void 0 ? void 0 : _vm$selectedCurrency5.code))) + "</span></div> <div class=\"total-item grand-total\" data-v-25e8a7cc><span data-v-25e8a7cc>ລວມທັງໝົດ:</span> <span class=\"amount\" data-v-25e8a7cc>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.calculatedTotal, (_vm$selectedCurrency6 = _vm.selectedCurrency) === null || _vm$selectedCurrency6 === void 0 ? void 0 : _vm$selectedCurrency6.code))) + "</span></div> " + (_vm.selectedCurrency && _vm.selectedCurrency.code !== 'LAK' && _vm.form.exchangeRate ? "<div class=\"total-item local-currency\" data-v-25e8a7cc><span data-v-25e8a7cc>ລວມເປັນ LAK:</span> <span class=\"amount local\" data-v-25e8a7cc>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.calculatedTotal * parseFloat(_vm.form.exchangeRate || 1), 'LAK'))) + "</span></div>" : "<!---->") + "</div></div> " + (_vm.isEdit ? "<div class=\"audit-trail-compact\" data-v-25e8a7cc><div class=\"audit-header\" data-v-25e8a7cc><h5 data-v-25e8a7cc>ປະຫວັດການດຳເນີນງານ</h5> <button type=\"button\" class=\"btn-view-audit\" data-v-25e8a7cc><i class=\"fas fa-external-link-alt\" data-v-25e8a7cc></i>\n                ເບິ່ງລະອຽດ\n              </button></div> <div class=\"audit-summary\" data-v-25e8a7cc><div class=\"audit-item\" data-v-25e8a7cc><i class=\"fas fa-user-edit\" data-v-25e8a7cc></i> <span data-v-25e8a7cc>" + _vm._ssrEscape("ສ້າງໂດຍ: " + _vm._s(_vm.auditTrail.makerName) + " (" + _vm._s(_vm.auditTrail.createdDate) + ")") + "</span></div> <div class=\"audit-item\" data-v-25e8a7cc><i class=\"fas fa-user-check\" data-v-25e8a7cc></i> <span data-v-25e8a7cc>" + _vm._ssrEscape(_vm._s(_vm.auditTrail.isChecked ? `ອະນຸມັດໂດຍ: ${_vm.auditTrail.checkerName}` : 'ລໍຖ້າການອະນຸມັດ')) + "</span></div> <div class=\"status-badge-container\" data-v-25e8a7cc><span" + _vm._ssrClass(null, ['status-badge', `status-${_vm.auditTrail.status}`]) + " data-v-25e8a7cc>" + _vm._ssrEscape("\n                  " + _vm._s(_vm.getStatusText(_vm.auditTrail.status)) + "\n                ") + "</span></div></div></div>" : "<!---->"))], 2)])]), _vm._ssrNode(" <div class=\"modal-footer\" data-v-25e8a7cc><div class=\"footer-actions\" data-v-25e8a7cc><button type=\"button\"" + _vm._ssrAttr("disabled", _vm.saving) + " class=\"btn btn-secondary\" data-v-25e8a7cc><i class=\"fas fa-times\" data-v-25e8a7cc></i>\n          ຍົກເລີກ\n        </button> <button type=\"button\"" + _vm._ssrAttr("disabled", _vm.saving || !_vm.isFormValid) + " class=\"btn btn-primary\" data-v-25e8a7cc>" + (_vm.saving ? "<i class=\"fas fa-spinner fa-spin\" data-v-25e8a7cc></i>" : "<i class=\"fas fa-save\" data-v-25e8a7cc></i>") + _vm._ssrEscape("\n          " + _vm._s(_vm.saving ? 'ກຳລັງບັນທຶກ...' : _vm.isEdit ? 'ອັບເດດ' : 'ບັນທຶກ') + "\n        ") + "</button></div></div>")], 2), _vm._ssrNode(" "), _c('audit-log-dialog', {
    attrs: {
...
// CONCATENATED MODULE: ./components/accounting/ap/invoice/index.vue?vue&type=template&id=25e8a7cc&scoped=true

// EXTERNAL MODULE: ./components/accounting/ap/invoice/audit/index.vue + 3 modules
var audit = __webpack_require__(696);
...
var component = Object(componentNormalizer["a" /* default */])(
  ap_invoicevue_type_script_lang_js,
  invoicevue_type_template_id_25e8a7cc_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "25e8a7cc",
