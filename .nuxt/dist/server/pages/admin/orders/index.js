...
/* harmony default export */ var ordersvue_type_script_lang_js = ({
  ...
  methods: {
    ...
    converseHandleInput(event) {
      ...
      if (isValid) {
        return Object(common["k" /* swalError2 */])(this.$swal, "Error", `CONVERT TO UPPER CASE ${input} TO ${input.toUpperCase()}`);
      } else {
        return Object(common["k" /* swalError2 */])(this.$swal, "Error", 'ລະບົບບໍ່ເຂົ້າໃຈພາສາລາວ ກະລຸນາປ່ງນພາສາ ເປັນພາສາອັງກິດ ກ່ອນສະແກນ');
      }
    },
...
// CONCATENATED MODULE: ./pages/admin/orders/index.vue?vue&type=script&lang=js
 /* harmony default export */ var admin_ordersvue_type_script_lang_js = (ordersvue_type_script_lang_js); 
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_ordersvue_type_script_lang_js,
