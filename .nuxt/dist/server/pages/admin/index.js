  ...
  data() {
    return {
      ...
      menus: [{
        ...
        svgIcon: __webpack_require__(803),
        path: '/pos/minimart'
      }, {
        title: 'Invoice',
        // icon: 'mdi-file-document-multiple',
        svgIcon: __webpack_require__(804),
        path: '/admin/ordersFromPos'
      }, {
        title: 'ລູກຫນີ້',
        // icon: 'mdi-credit-card-refresh-outline',
        svgIcon: __webpack_require__(805),
        path: '/admin/ordersFromPosCredit'
      }, {
        title: 'Stock',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(806),
...
installComponents(component, {LoadingIndicator: __webpack_require__(86).default,Menu: __webpack_require__(762).default,MenuOverview: __webpack_require__(640).default,MinStockCard: __webpack_require__(639).default})
