exports.ids = [154,28,36,37,39,40,62,65,66,87,90,91,188,253];
exports.modules = {
  ...
  data() {
    return {
      ...
      menus: [{
        ...
        svgIcon: __webpack_require__(807),
        path: '/pos/minimart'
      }, {
        title: 'Invoice',
        // icon: 'mdi-file-document-multiple',
        svgIcon: __webpack_require__(808),
        path: '/admin/ordersFromPos'
      }, {
        title: 'ລູກຫນີ້',
        // icon: 'mdi-credit-card-refresh-outline',
        svgIcon: __webpack_require__(809),
        path: '/admin/ordersFromPosCredit'
      }, {
        title: 'Stock',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(810),
        ...
        //231001 CR By Bae
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(811),
        // path: '/admin/ordersFromPos'
        path: '/admin/ordersFromPosSummaryByCustomer' //231001 CR By Bae
      }, {
        title: 'Customer',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(812),
        path: '/admin/client'
      }
      // {
...
installComponents(component, {LoadingIndicator: __webpack_require__(86).default,Menu: __webpack_require__(766).default,MenuOverview: __webpack_require__(645).default,MinStockCard: __webpack_require__(644).default})
