exports.ids = [175,34,42,43,45,46,82,85,86,107,110,111,211,276];
exports.modules = {
  ...
  data() {
    return {
      ...
      menus: [{
        ...
        svgIcon: __webpack_require__(866),
        path: '/pos/minimart'
      }, {
        title: 'Invoice',
        // icon: 'mdi-file-document-multiple',
        svgIcon: __webpack_require__(867),
        path: '/admin/ordersFromPos'
      }, {
        title: 'ລູກຫນີ້',
        // icon: 'mdi-credit-card-refresh-outline',
        svgIcon: __webpack_require__(868),
        path: '/admin/ordersFromPosCredit'
      }, {
        title: 'Stock',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(869),
        ...
        //231001 CR By Bae
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(870),
        // path: '/admin/ordersFromPos'
...
installComponents(component, {LoadingIndicator: __webpack_require__(86).default,Menu: __webpack_require__(825).default,MenuOverview: __webpack_require__(691).default,MinStockCard: __webpack_require__(690).default})
