exports.ids = [205,41,50,51,54,55,96,99,100,123,126,127,319];
exports.modules = {
  ...
  data() {
    return {
      ...
      menus: [{
        ...
        svgIcon: __webpack_require__(1000),
        path: '/pos/minimart'
      }, {
        title: 'Invoice',
        // icon: 'mdi-file-document-multiple',
        svgIcon: __webpack_require__(1001),
        path: '/admin/ordersFromPos'
      }, {
        title: 'ລູກຫນີ້',
        // icon: 'mdi-credit-card-refresh-outline',
        svgIcon: __webpack_require__(1002),
        path: '/admin/ordersFromPosCredit'
      }, {
        title: 'Stock',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(1003),
        ...
        //231001 CR By Bae
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(1004),
        // path: '/admin/ordersFromPos'
        path: '/admin/ordersFromPosSummaryByCustomer' //231001 CR By Bae
      }, {
        title: 'Customer',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(1005),
        path: '/admin/client'
      }
      // {
...
installComponents(component, {LoadingIndicator: __webpack_require__(87).default,Menu: __webpack_require__(959).default,MenuOverview: __webpack_require__(796).default,MinStockCard: __webpack_require__(795).default})
