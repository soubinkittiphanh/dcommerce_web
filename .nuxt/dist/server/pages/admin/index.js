exports.ids = [206,41,50,51,54,55,96,99,100,124,127,128,320];
exports.modules = {
  ...
  data() {
    return {
      ...
      menus: [{
        ...
        svgIcon: __webpack_require__(1012),
        path: '/pos/minimart'
      }, {
        title: 'Invoice',
        // icon: 'mdi-file-document-multiple',
        svgIcon: __webpack_require__(1013),
        path: '/admin/ordersFromPos'
      }, {
        title: 'ລູກຫນີ້',
        // icon: 'mdi-credit-card-refresh-outline',
        svgIcon: __webpack_require__(1014),
        path: '/admin/ordersFromPosCredit'
      }, {
        title: 'Stock',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(1015),
        ...
        //231001 CR By Bae
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(1016),
        // path: '/admin/ordersFromPos'
        path: '/admin/ordersFromPosSummaryByCustomer' //231001 CR By Bae
      }, {
        title: 'Customer',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(1017),
        path: '/admin/client'
      }
      // {
...
installComponents(component, {LoadingIndicator: __webpack_require__(87).default,Menu: __webpack_require__(970).default,MenuOverview: __webpack_require__(806).default,MinStockCard: __webpack_require__(805).default})
