...
var minStockCard = __webpack_require__(880);

// EXTERNAL MODULE: ./components/menuOverview/index.vue + 4 modules
var menuOverview = __webpack_require__(1067);
  ...
  data() {
    return {
      ...
      menus: [{
        ...
        title: 'Customer',
        svgIcon: __webpack_require__(1117),
        path: '/admin/client'
      }],
      yearlySale: [],
      menusOverview: [{
...
installComponents(component, {MinStockCard: __webpack_require__(880).default})
