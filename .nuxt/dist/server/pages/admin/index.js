exports.ids = [160,34,42,43,45,46,68,71,72,93,96,97,195,260];
exports.modules = {
  ...
  data() {
    return {
      ...
      menus: [{
        ...
        //231001 CR By Bae
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(837),
        // path: '/admin/ordersFromPos'
        path: '/admin/ordersFromPosSummaryByCustomer' //231001 CR By Bae
      }, {
        title: 'Customer',
        // icon: 'mdi-warehouse',
        svgIcon: __webpack_require__(838),
        path: '/admin/client'
      }
      // {
...
installComponents(component, {LoadingIndicator: __webpack_require__(86).default,Menu: __webpack_require__(795).default,MenuOverview: __webpack_require__(672).default,MinStockCard: __webpack_require__(671).default})
