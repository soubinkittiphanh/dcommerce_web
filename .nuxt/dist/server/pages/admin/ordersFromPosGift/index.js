...
var ticket = __webpack_require__(165);
...
var TicketDetailsDialog = __webpack_require__(614);
  ...
  computed: {
    ...
    companyLogo() {
      ...
      if (company.ticketLogo) {
        try {
          return __webpack_require__(144)(`./${company.ticketLogo}`);
        } catch (error) {
...
installComponents(component, {LoadingIndicator: __webpack_require__(70).default,YoutubePlayer: __webpack_require__(476).default,OrderDetailPosCRUD: __webpack_require__(479).default})
