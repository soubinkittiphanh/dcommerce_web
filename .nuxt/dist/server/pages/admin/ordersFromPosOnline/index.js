exports.ids = [253,40,112,113,118];
exports.modules = {
  ...
  computed: {
    ...
    companyLogo() {
      ...
      if (company.ticketLogo) {
        try {
          const staticLogo = __webpack_require__(144)(`./${company.ticketLogo}`);
      ...
      if (company.dcLogo) {
        try {
          const fallbackLogo = __webpack_require__(144)(`./${company.dcLogo}`);
...
installComponents(component, {LoadingIndicator: __webpack_require__(70).default,OrderDetailPosCRUD: __webpack_require__(479).default,CancelTicketForm: __webpack_require__(457).default,OrderSumaryCardPos: __webpack_require__(480).default})
