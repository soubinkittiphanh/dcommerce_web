...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin/moneyAdvanceSettlementByBank/index.vue?vue&type=template&id=18fed5bf&scoped=true&
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "settlement-summary-container"
  }, [_vm._ssrNode("<div class=\"page-header\" data-v-18fed5bf><div class=\"header-content\" data-v-18fed5bf><h1 class=\"page-title\" data-v-18fed5bf>ສະຫລຸບບັນຊີ ລາຍຮັບ</h1> <div class=\"header-actions\" data-v-18fed5bf><button class=\"btn btn-primary\" data-v-18fed5bf><i class=\"fas fa-plus\" data-v-18fed5bf></i>\n          ລົງລາຍຮັບ ການຊຳລະ\n        </button> <button class=\"btn btn-secondary\" data-v-18fed5bf><i class=\"fas fa-download\" data-v-18fed5bf></i>\n          Export\n        </button></div></div></div> "), _vm._ssrNode("<div class=\"filter-section\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<div class=\"filter-row\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<div class=\"filter-group\" data-v-18fed5bf><label data-v-18fed5bf>ເລືອກຕາມວັນທີ:</label> <input type=\"date\"" + _vm._ssrAttr("value", _vm.filters.startDate) + " class=\"form-control\" data-v-18fed5bf> <span class=\"date-separator\" data-v-18fed5bf>ຫາ</span> <input type=\"date\"" + _vm._ssrAttr("value", _vm.filters.endDate) + " class=\"form-control\" data-v-18fed5bf></div> "), _vm._ssrNode("<div class=\"filter-group\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<label data-v-18fed5bf>ຊ່ອງທາງລາຍຮັບ:</label> "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm._v("Deduction")])])], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"filter-group\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<label data-v-18fed5bf>ເລືອກບັນຊີ:</label> "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  })], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"filter-group\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<label data-v-18fed5bf>ເລືອກກະຊວງ:</label> "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  })], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"filter-group\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<label data-v-18fed5bf>ເລືອກບັນຊີລວມ:</label> "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  })], 2)], 2), _vm._ssrNode(" <div class=\"filter-actions\" data-v-18fed5bf><button class=\"btn btn-outline-primary\" data-v-18fed5bf><i class=\"fas fa-search\" data-v-18fed5bf></i>\n          ຄົ້ນຫາ\n        </button> <button class=\"btn btn-outline-secondary\" data-v-18fed5bf><i class=\"fas fa-undo\" data-v-18fed5bf></i>\n          Reset\n        </button></div>")], 2)]), _vm._ssrNode(" <div class=\"summary-cards\" data-v-18fed5bf><div class=\"summary-card total-lak\" data-v-18fed5bf><div class=\"card-icon total\" data-v-18fed5bf><i class=\"fas fa-calculator\" data-v-18fed5bf></i></div> <div class=\"card-content\" data-v-18fed5bf><h3 data-v-18fed5bf>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.summaryStats.totalLAK.amount, 'LAK'))) + "</h3> <p data-v-18fed5bf>" + _vm._ssrEscape("ລວມຍອດທັງໝົດ (LAK) - " + _vm._s(_vm.summaryStats.totalLAK.count) + " ລາຍການ") + "</p></div></div> " + _vm._ssrList(_vm.summaryStats.currencies, function (currencyStat) {
    return "<div class=\"summary-card currency-card\" data-v-18fed5bf><div class=\"card-icon currency\" data-v-18fed5bf><i class=\"fas fa-coins\" data-v-18fed5bf></i></div> <div class=\"card-content\" data-v-18fed5bf><h3 data-v-18fed5bf>" + _vm._ssrEscape("\n          " + _vm._s(_vm.formatCurrencyAmount(currencyStat.originalAmount, currencyStat.currencyCode)) + "\n        ") + "</h3> <p class=\"currency-name\" data-v-18fed5bf>" + _vm._ssrEscape("\n          " + _vm._s(currencyStat.currencyName) + " (" + _vm._s(currencyStat.count) + " ລາຍການ)\n        ") + "</p> <p class=\"lak-equivalent\" data-v-18fed5bf>" + _vm._ssrEscape("\n          ≈ " + _vm._s(_vm.formatCurrency(currencyStat.lakEquivalent, 'LAK')) + "\n        ") + "</p></div></div>";
  }) + "</div> "), _vm._ssrNode("<div class=\"table-section\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<div class=\"table-header\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<div class=\"table-title\" data-v-18fed5bf><h3 data-v-18fed5bf>ລາຍການຮັບເງິນ</h3> <span class=\"record-count\" data-v-18fed5bf>" + _vm._ssrEscape(_vm._s(_vm.filteredSettlements.length) + " ລາຍການ") + "</span></div> "), _vm._ssrNode("<div class=\"table-actions\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<div class=\"per-page-selector\" data-v-18fed5bf>", "</div>", [_vm._ssrNode("<label data-v-18fed5bf>Show:</label> "), _c('select', {
    directives: [{
      name: "model",
      rawName: "v-model",
  ...
  }, [_vm._v("100")])]), _vm._ssrNode(" <span data-v-18fed5bf>per page</span>")], 2)])], 2), _vm._ssrNode(" <div class=\"table-container\" data-v-18fed5bf><table class=\"data-table\" data-v-18fed5bf><thead data-v-18fed5bf><tr data-v-18fed5bf><th class=\"sortable\" data-v-18fed5bf>\n              ID\n              <i" + _vm._ssrClass(null, _vm.getSortIcon('id')) + " data-v-18fed5bf></i></th> <th class=\"sortable\" data-v-18fed5bf>\n              ວັນທີລົງຊຳລະ\n              <i" + _vm._ssrClass(null, _vm.getSortIcon('settlementDate')) + " data-v-18fed5bf></i></th> <th class=\"sortable\" data-v-18fed5bf>\n              Payment Method\n              <i" + _vm._ssrClass(null, _vm.getSortIcon('method')) + " data-v-18fed5bf></i></th> <th class=\"sortable\" data-v-18fed5bf>\n              ຜູ້ລົງບັນຊີ\n              <i" + _vm._ssrClass(null, _vm.getSortIcon('requester')) + " data-v-18fed5bf></i></th> <th class=\"sortable\" data-v-18fed5bf>\n              ຈຳນວນເງິນ\n              <i" + _vm._ssrClass(null, _vm.getSortIcon('amount')) + " data-v-18fed5bf></i></th> <th data-v-18fed5bf>ສະກຸນເງິນ</th> <th data-v-18fed5bf>Ministry</th> <th data-v-18fed5bf>Chart Account</th> <th data-v-18fed5bf>ຟັງຊັ່ນ</th></tr></thead> <tbody data-v-18fed5bf>" + _vm._ssrList(_vm.paginatedSettlements, function (settlement) {
    return "<tr data-v-18fed5bf><td data-v-18fed5bf>" + _vm._ssrEscape(_vm._s(settlement.id) + " " + _vm._s(settlement.moneyAdvanceId)) + "</td> <td data-v-18fed5bf>" + _vm._ssrEscape(_vm._s(_vm.formatDate(settlement.settlementDate))) + "</td> <td data-v-18fed5bf><span" + _vm._ssrClass(null, ['method-badge', settlement.method]) + " data-v-18fed5bf>" + _vm._ssrEscape("\n                " + _vm._s(_vm.formatMethod(settlement.method)) + "\n              ") + "</span></td> <td data-v-18fed5bf>" + _vm._ssrEscape(_vm._s(settlement.requester)) + "</td> <td class=\"amount-cell\" data-v-18fed5bf>" + _vm._ssrEscape("\n              " + _vm._s(_vm.formatSettlementAmount(settlement)) + "\n            ") + "</td> <td data-v-18fed5bf>" + (_vm.getSettlementCurrency(settlement) ? "<span class=\"currency-tag\" data-v-18fed5bf>" + _vm._ssrEscape("\n                " + _vm._s(_vm.getSettlementCurrency(settlement).code) + "\n              ") + "</span>" : "<span class=\"no-data\" data-v-18fed5bf>-</span>") + "</td> <td data-v-18fed5bf>" + (settlement.ministry ? "<span class=\"ministry-tag\" data-v-18fed5bf>" + _vm._ssrEscape("\n                " + _vm._s(settlement.ministry.ministryCode) + "\n              ") + "</span>" : "<span class=\"no-data\" data-v-18fed5bf>-</span>") + "</td> <td data-v-18fed5bf>" + (settlement.chartAccount ? "<span class=\"chart-account-tag\" data-v-18fed5bf>" + _vm._ssrEscape("\n                " + _vm._s(settlement.chartAccount.accountNumber) + "\n              ") + "</span>" : "<span class=\"no-data\" data-v-18fed5bf>-</span>") + "</td> <td class=\"actions-cell\" data-v-18fed5bf><button title=\"View Details\" class=\"btn btn-sm btn-outline-primary\" data-v-18fed5bf><i class=\"fas fa-eye\" data-v-18fed5bf></i></button> <button title=\"Edit\" class=\"btn btn-sm btn-outline-info\" data-v-18fed5bf><i class=\"fas fa-edit\" data-v-18fed5bf></i></button> <button title=\"Print\" class=\"btn btn-sm btn-outline-secondary\" data-v-18fed5bf><i class=\"fas fa-print\" data-v-18fed5bf></i></button></td></tr>";
  }) + "</tbody></table></div> <div class=\"pagination-container\" data-v-18fed5bf><div class=\"pagination-info\" data-v-18fed5bf>" + _vm._ssrEscape("\n        Showing " + _vm._s(_vm.paginationInfo.start) + " to " + _vm._s(_vm.paginationInfo.end) + " of\n        " + _vm._s(_vm.paginationInfo.total) + " entries\n      ") + "</div> <div class=\"pagination-controls\" data-v-18fed5bf><button" + _vm._ssrAttr("disabled", _vm.pagination.currentPage === 1) + " class=\"btn btn-sm btn-outline-secondary\" data-v-18fed5bf>\n          Previous\n        </button> " + _vm._ssrList(_vm.visiblePages, function (page) {
    return "<span data-v-18fed5bf>" + (page !== '...' ? "<button" + _vm._ssrClass("btn btn-sm", page === _vm.pagination.currentPage ? 'btn-primary' : 'btn-outline-secondary') + " data-v-18fed5bf>" + _vm._ssrEscape("\n            " + _vm._s(page) + "\n          ") + "</button>" : "<span class=\"pagination-ellipsis\" data-v-18fed5bf>...</span>") + "</span>";
  }) + " <button" + _vm._ssrAttr("disabled", _vm.pagination.currentPage === _vm.totalPages) + " class=\"btn btn-sm btn-outline-secondary\" data-v-18fed5bf>\n          Next\n        </button></div></div>")], 2), _vm._ssrNode(" "), _c('client-only', [_c('SettlementDialog', {
    attrs: {
  ...
  })], 1), _vm._ssrNode(" " + (_vm.loading ? "<div class=\"loading-overlay\" data-v-18fed5bf><div class=\"loading-spinner\" data-v-18fed5bf><i class=\"fas fa-spinner fa-spin\" data-v-18fed5bf></i> <p data-v-18fed5bf>Loading...</p></div></div>" : "<!---->"))], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./pages/admin/moneyAdvanceSettlementByBank/index.vue?vue&type=template&id=18fed5bf&scoped=true&
...
var settlementDialog = __webpack_require__(510);

// EXTERNAL MODULE: ./components/MA/settlementViewDialog/index.vue + 4 modules
var settlementViewDialog = __webpack_require__(583);
...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("25bfa2e4", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_18fed5bf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(717);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_18fed5bf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_18fed5bf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_18fed5bf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_18fed5bf_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".settlement-summary-container[data-v-18fed5bf]{background-color:#f5f5f5;min-height:100vh;padding:20px}.page-header[data-v-18fed5bf]{background:#fff;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:20px}.header-content[data-v-18fed5bf]{align-items:center;display:flex;justify-content:space-between}.page-title[data-v-18fed5bf]{color:#333;font-size:28px;font-weight:600;margin:0}.header-actions[data-v-18fed5bf]{display:flex;gap:12px}.filter-section[data-v-18fed5bf]{background:#fff;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);margin-bottom:20px;padding:20px}.filter-row[data-v-18fed5bf]{align-items:flex-end;display:flex;flex-wrap:wrap;gap:20px}.filter-group[data-v-18fed5bf]{display:flex;flex-direction:column;gap:8px}.filter-group label[data-v-18fed5bf]{color:#555;font-size:14px;font-weight:500}.date-separator[data-v-18fed5bf]{align-self:flex-end;color:#666;padding:8px}.filter-actions[data-v-18fed5bf]{align-self:flex-end;display:flex;gap:8px}.summary-cards[data-v-18fed5bf]{grid-gap:20px;display:grid;gap:20px;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));margin-bottom:20px}.summary-card[data-v-18fed5bf]{align-items:flex-start;background:#fff;border:1px solid #e9ecef;border-radius:12px;box-shadow:0 4px 6px rgba(0,0,0,.1);display:flex;padding:24px;transition:all .3s ease}.summary-card[data-v-18fed5bf]:hover{box-shadow:0 8px 16px rgba(0,0,0,.15);transform:translateY(-4px)}.summary-card.total-lak[data-v-18fed5bf]{background:linear-gradient(135deg,#667eea,#764ba2);border:none;color:#fff}.summary-card.total-lak .card-icon[data-v-18fed5bf]{background:hsla(0,0%,100%,.2);color:#fff}.summary-card.total-lak .card-content h3[data-v-18fed5bf]{color:#fff;font-size:28px;font-weight:700}.summary-card.total-lak .card-content p[data-v-18fed5bf]{color:hsla(0,0%,100%,.9)}.summary-card.currency-card[data-v-18fed5bf]{background:#fff;border-left:4px solid #28a745}.card-icon[data-v-18fed5bf]{align-items:center;border-radius:50%;display:flex;flex-shrink:0;font-size:24px;height:60px;justify-content:center;margin-right:20px;width:60px}.card-icon.total[data-v-18fed5bf]{background:hsla(0,0%,100%,.2);color:#fff}.card-icon.currency[data-v-18fed5bf]{background:#e8f5e8;color:#28a745}.card-content[data-v-18fed5bf]{flex:1;min-width:0}.card-content h3[data-v-18fed5bf]{font-size:24px;font-weight:700;margin:0 0 8px;word-break:break-word}.card-content p[data-v-18fed5bf]{font-size:14px;margin:0}.currency-name[data-v-18fed5bf]{color:#495057;font-weight:600;margin-bottom:4px!important}.lak-equivalent[data-v-18fed5bf]{color:#6c757d;font-size:13px!important;font-style:italic}@keyframes slideInUp-18fed5bf{0%{opacity:0;transform:translateY(20px)}to{opacity:1;transform:translateY(0)}}.summary-card[data-v-18fed5bf]{animation:slideInUp-18fed5bf .5s ease-out}.currency-code[data-v-18fed5bf]{color:#007bff;font-weight:600}.table-section[data-v-18fed5bf]{background:#fff;border-radius:8px;box-shadow:0 2px 4px rgba(0,0,0,.1);overflow:hidden}.table-header[data-v-18fed5bf]{align-items:center;border-bottom:1px solid #e9ecef;display:flex;justify-content:space-between;padding:20px}.table-title h3[data-v-18fed5bf]{color:#333;margin:0}.record-count[data-v-18fed5bf]{color:#666;font-size:14px;margin-left:8px}.per-page-selector[data-v-18fed5bf]{align-items:center;display:flex;font-size:14px;gap:8px}.table-container[data-v-18fed5bf]{overflow-x:auto}.data-table[data-v-18fed5bf]{border-collapse:collapse;width:100%}.data-table td[data-v-18fed5bf],.data-table th[data-v-18fed5bf]{border-bottom:1px solid #e9ecef;padding:12px 16px;text-align:left}.data-table th[data-v-18fed5bf]{background-color:#f8f9fa;color:#495057;font-weight:600}.data-table th.sortable[data-v-18fed5bf]{cursor:pointer;transition:background-color .2s;-webkit-user-select:none;-moz-user-select:none;user-select:none}.data-table th.sortable[data-v-18fed5bf]:hover{background-color:#e9ecef}.data-table th i[data-v-18fed5bf]{margin-left:8px;opacity:.5}.amount-cell[data-v-18fed5bf]{color:#28a745;font-weight:600}.actions-cell[data-v-18fed5bf]{display:flex;gap:8px}.method-badge[data-v-18fed5bf]{border-radius:20px;font-size:12px;font-weight:500;padding:4px 12px;text-transform:capitalize}.method-badge.cash[data-v-18fed5bf]{background-color:#d4edda;color:#155724}.method-badge.bank_transfer[data-v-18fed5bf]{background-color:#d1ecf1;color:#0c5460}.method-badge.deduction[data-v-18fed5bf]{background-color:#fce4ec;color:#880e4f}.ministry-tag[data-v-18fed5bf]{background-color:#e7f3ff;color:#06c}.chart-account-tag[data-v-18fed5bf],.ministry-tag[data-v-18fed5bf]{border-radius:12px;font-size:11px;font-weight:500;padding:3px 8px}.chart-account-tag[data-v-18fed5bf]{background-color:#fff3cd;color:#856404}.currency-tag[data-v-18fed5bf]{background-color:#e8f5e8;border-radius:12px;color:#28a745;font-size:11px;font-weight:600;padding:3px 8px;text-transform:uppercase}.no-data[data-v-18fed5bf]{color:#999;font-size:12px;font-style:italic}.pagination-container[data-v-18fed5bf]{align-items:center;border-top:1px solid #e9ecef;display:flex;justify-content:space-between;padding:20px}.pagination-info[data-v-18fed5bf]{color:#666;font-size:14px}.pagination-controls[data-v-18fed5bf]{align-items:center;display:flex;gap:8px}.pagination-ellipsis[data-v-18fed5bf]{color:#666;padding:6px 12px}.btn[data-v-18fed5bf]{align-items:center;border:1px solid transparent;border-radius:6px;cursor:pointer;display:inline-flex;font-size:14px;font-weight:500;gap:8px;padding:8px 16px;-webkit-text-decoration:none;text-decoration:none;transition:all .2s}.btn[data-v-18fed5bf]:disabled{cursor:not-allowed;opacity:.5}.btn-primary[data-v-18fed5bf]{background-color:#007bff;border-color:#007bff;color:#fff}.btn-primary[data-v-18fed5bf]:hover:not(:disabled){background-color:#0056b3;border-color:#0056b3}.btn-secondary[data-v-18fed5bf]{background-color:#6c757d;border-color:#6c757d;color:#fff}.btn-secondary[data-v-18fed5bf]:hover:not(:disabled){background-color:#5a6268;border-color:#5a6268}.btn-outline-primary[data-v-18fed5bf]{background-color:transparent;border-color:#007bff;color:#007bff}.btn-outline-primary[data-v-18fed5bf]:hover{background-color:#007bff;color:#fff}.btn-outline-secondary[data-v-18fed5bf]{background-color:transparent;border-color:#6c757d;color:#6c757d}.btn-outline-secondary[data-v-18fed5bf]:hover{background-color:#6c757d;color:#fff}.btn-outline-info[data-v-18fed5bf]{background-color:transparent;border-color:#17a2b8;color:#17a2b8}.btn-outline-info[data-v-18fed5bf]:hover{background-color:#17a2b8;color:#fff}.btn-sm[data-v-18fed5bf]{font-size:12px;padding:4px 8px}.form-control[data-v-18fed5bf]{border:1px solid #ced4da;border-radius:4px;font-size:14px;padding:8px 12px;transition:border-color .2s}.form-control[data-v-18fed5bf]:focus{border-color:#007bff;box-shadow:0 0 0 2px rgba(0,123,255,.25);outline:none}.loading-overlay[data-v-18fed5bf]{align-items:center;background-color:rgba(0,0,0,.5);bottom:0;display:flex;justify-content:center;left:0;position:fixed;right:0;top:0;z-index:1000}.loading-spinner[data-v-18fed5bf]{background:#fff;border-radius:8px;padding:40px;text-align:center}.loading-spinner i[data-v-18fed5bf]{color:#007bff;font-size:32px;margin-bottom:16px}@media (max-width:768px){.settlement-summary-container[data-v-18fed5bf]{padding:10px}.header-content[data-v-18fed5bf]{align-items:flex-start}.filter-row[data-v-18fed5bf],.header-content[data-v-18fed5bf]{flex-direction:column;gap:16px}.filter-group[data-v-18fed5bf]{width:100%}.filter-actions[data-v-18fed5bf]{flex-direction:row;width:100%}.summary-cards[data-v-18fed5bf]{gap:16px;grid-template-columns:1fr}.summary-card[data-v-18fed5bf]{padding:20px}.card-icon[data-v-18fed5bf]{height:50px;margin-right:16px;width:50px}.card-content h3[data-v-18fed5bf],.card-icon[data-v-18fed5bf]{font-size:20px}.pagination-container[data-v-18fed5bf],.table-header[data-v-18fed5bf]{align-items:flex-start;flex-direction:column;gap:16px}.pagination-controls[data-v-18fed5bf]{flex-wrap:wrap}.actions-cell[data-v-18fed5bf]{flex-direction:column;gap:4px}}@media (max-width:576px){.summary-card[data-v-18fed5bf]{flex-direction:column;text-align:center}.card-icon[data-v-18fed5bf]{margin:0 auto 16px}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
