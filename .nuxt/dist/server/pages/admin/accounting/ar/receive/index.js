...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("20bea567", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_a7b44af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(654);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_a7b44af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_a7b44af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_a7b44af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_3_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_3_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_ref_3_oneOf_1_2_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_index_vue_vue_type_style_index_0_id_a7b44af8_prod_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".modal-overlay[data-v-a7b44af8]{align-items:center;background-color:rgba(0,0,0,.7);display:flex;height:100vh;justify-content:center;left:0;padding:0;position:fixed;top:0;width:100vw;z-index:1050}.enhanced-dialog[data-v-a7b44af8]{height:100vh;width:100vw}.enhanced-dialog[data-v-a7b44af8],.invoice-browser-dialog[data-v-a7b44af8]{background:#fff;display:flex;flex-direction:column;overflow:hidden}.invoice-browser-dialog[data-v-a7b44af8]{border-radius:8px;box-shadow:0 10px 30px rgba(0,0,0,.3);height:80vh;max-height:80vh;max-width:90vw;width:100%}.modal-header[data-v-a7b44af8]{background:linear-gradient(135deg,#01532b,#337555);border-bottom:1px solid #e9ecef;color:#fff;justify-content:space-between;min-height:50px;padding:10px 15px}.modal-header[data-v-a7b44af8],.modal-title[data-v-a7b44af8]{align-items:center;display:flex}.modal-title[data-v-a7b44af8]{font-size:16px;font-weight:600;gap:8px;margin:0}.close-button[data-v-a7b44af8]{background:none;border:none;border-radius:4px;color:#fff;cursor:pointer;font-size:18px;padding:4px;transition:background .2s}.close-button[data-v-a7b44af8]:hover{background:hsla(0,0%,100%,.2)}.modal-body[data-v-a7b44af8]{flex:1;overflow-y:auto}.loading-state[data-v-a7b44af8],.modal-body[data-v-a7b44af8]{display:flex;flex-direction:column}.loading-state[data-v-a7b44af8]{align-items:center;color:#666;justify-content:center;padding:30px}.spinner[data-v-a7b44af8]{animation:spin-a7b44af8 1s linear infinite;border:3px solid #f3f3f3;border-radius:50%;border-top-color:#28a745;height:30px;margin-bottom:10px;width:30px}@keyframes spin-a7b44af8{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}.receipt-form[data-v-a7b44af8]{display:flex;flex:1;flex-direction:column}.form-section[data-v-a7b44af8]{border-bottom:1px solid #f0f0f0;padding:15px 20px}.section-header[data-v-a7b44af8]{flex-wrap:wrap;gap:10px;justify-content:space-between;margin-bottom:12px}.section-header[data-v-a7b44af8],.section-title[data-v-a7b44af8]{align-items:center;display:flex}.section-title[data-v-a7b44af8]{border-bottom:1px solid #e9ecef;color:#333;font-size:14px;font-weight:600;gap:8px;margin:0 0 12px;padding-bottom:6px}.section-title i[data-v-a7b44af8]{color:#28a745;font-size:13px}.line-count[data-v-a7b44af8]{background:#28a745;border-radius:10px;color:#fff;font-size:11px;margin-left:4px;min-width:20px;padding:2px 8px;text-align:center}.form-row[data-v-a7b44af8]{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));grid-gap:10px;gap:10px;margin-bottom:12px}.form-group[data-v-a7b44af8]{margin-bottom:0}.form-group.full-width[data-v-a7b44af8]{grid-column:1/-1}.form-group label[data-v-a7b44af8]{color:#333;display:block;font-size:12px;font-weight:500;margin-bottom:3px}.form-group label.required[data-v-a7b44af8]:after{color:#e74c3c;content:\" *\"}.form-control[data-v-a7b44af8]{border:1px solid #ddd;border-radius:4px;font-size:13px;line-height:1.2;padding:6px 8px;transition:border-color .2s,box-shadow .2s;width:100%}.form-control[data-v-a7b44af8]:focus{border-color:#28a745;box-shadow:0 0 0 2px rgba(40,167,69,.1);outline:none}.form-control.is-invalid[data-v-a7b44af8]{border-color:#e74c3c;box-shadow:0 0 0 2px rgba(231,76,60,.1)}.form-control-xs[data-v-a7b44af8]{font-size:12px;padding:4px 6px}.textarea-compact[data-v-a7b44af8]{min-height:50px;resize:vertical}.invalid-feedback[data-v-a7b44af8]{color:#e74c3c;display:block;font-size:11px;margin-top:3px;width:100%}.auto-calculated-field[data-v-a7b44af8]{background-color:#f8f9fa!important;border-style:dashed!important;color:#495057!important;cursor:not-allowed;font-weight:600}.auto-calculated-field[data-v-a7b44af8]:disabled{opacity:.8}.form-group label.auto-calculated[data-v-a7b44af8]{align-items:center;color:#28a745;display:flex;font-weight:600;gap:6px}.form-text.text-muted[data-v-a7b44af8]{align-items:center;color:#6c757d!important;display:flex;font-size:11px;gap:4px;margin-top:3px}.invoice-selector[data-v-a7b44af8]{display:flex;gap:8px}.invoice-selector select[data-v-a7b44af8]{flex:1}.quick-allocation-actions[data-v-a7b44af8]{display:flex;flex-wrap:wrap;gap:6px}.no-invoice-state[data-v-a7b44af8],.no-lines-state[data-v-a7b44af8],.no-results-state[data-v-a7b44af8]{background:#f8f9fa;border:2px dashed #dee2e6;border-radius:6px;margin-top:12px;padding:30px 20px;text-align:center}.empty-content i[data-v-a7b44af8]{color:#dee2e6;font-size:40px;margin-bottom:12px}.empty-content h4[data-v-a7b44af8]{color:#666;font-size:15px;margin-bottom:8px}.empty-content p[data-v-a7b44af8]{color:#999;font-size:13px;margin-bottom:15px}.allocation-notice[data-v-a7b44af8]{align-items:center;background:#e7f3ff;border-left:3px solid #007bff;border-radius:4px;color:#495057;display:flex;font-size:12px;gap:8px;margin-bottom:15px;padding:10px}.allocation-table-container[data-v-a7b44af8],.invoice-table-container[data-v-a7b44af8]{border:1px solid #e9ecef;border-radius:6px;margin-top:12px;max-height:400px;overflow:hidden;overflow-y:auto}.allocation-table .table[data-v-a7b44af8],.invoice-table-container .table[data-v-a7b44af8]{border-collapse:collapse;margin:0;width:100%}.table-compact[data-v-a7b44af8]{font-size:12px}.allocation-table .table th[data-v-a7b44af8],.invoice-table-container .table th[data-v-a7b44af8]{background:#f8f9fa;border-bottom:1px solid #dee2e6;font-size:11px;font-weight:600;padding:6px 4px;position:sticky;text-align:center;top:0;z-index:10}.allocation-table .table td[data-v-a7b44af8],.invoice-table-container .table td[data-v-a7b44af8]{border-top:1px solid #dee2e6;font-size:11px;padding:4px;vertical-align:middle}.line-number[data-v-a7b44af8]{color:#666;font-weight:600;text-align:center}.invoice-line-display[data-v-a7b44af8]{line-height:1.3}.line-description[data-v-a7b44af8]{color:#333;font-size:12px;font-weight:500;margin-bottom:2px}.line-details[data-v-a7b44af8]{color:#666;font-size:10px}.invoice-line-total[data-v-a7b44af8],.remaining-amount[data-v-a7b44af8]{color:#28a745;font-size:11px;font-weight:600;text-align:right}.over-allocated[data-v-a7b44af8]{color:#dc3545!important}.fully-allocated[data-v-a7b44af8]{color:#6c757d!important}.allocation-row[data-v-a7b44af8],.invoice-row[data-v-a7b44af8]{transition:background-color .2s}.allocation-row[data-v-a7b44af8]:hover,.invoice-row[data-v-a7b44af8]:hover{background-color:rgba(40,167,69,.05)}.amount-summary[data-v-a7b44af8]{background:#f8f9fa;border-bottom:1px solid #f0f0f0;border-radius:0;border-top:2px solid #28a745;padding:12px 20px}.totals-compact[data-v-a7b44af8]{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));grid-gap:8px;gap:8px}.total-item[data-v-a7b44af8]{align-items:center;display:flex;font-size:12px;justify-content:space-between;padding:4px 0}.total-item.success-balance[data-v-a7b44af8]{background:#d4edda;border-radius:4px;grid-column:1/-1;padding:6px 8px}.total-item .amount[data-v-a7b44af8]{color:#333;font-weight:600}.total-item .amount.received[data-v-a7b44af8]{color:#28a745}.total-item .amount.allocated[data-v-a7b44af8]{color:#007bff}.amount.balanced[data-v-a7b44af8]{color:#155724!important;font-weight:600;gap:4px}.amount.balanced[data-v-a7b44af8],.balance-info[data-v-a7b44af8]{align-items:center;display:flex}.balance-info[data-v-a7b44af8]{background:#e7f3ff;border:1px solid #bee5eb;border-radius:4px;color:#0c5460;font-size:12px;gap:6px;margin-top:10px;padding:8px}.search-section[data-v-a7b44af8]{background:#f8f9fa;border-bottom:1px solid #e9ecef;padding:15px}.search-input-group[data-v-a7b44af8]{max-width:400px;position:relative}.search-icon[data-v-a7b44af8]{color:#666;font-size:14px;left:10px;position:absolute;top:50%;transform:translateY(-50%)}.search-input[data-v-a7b44af8]{border-radius:6px;font-size:14px;padding-left:35px}.invoice-list[data-v-a7b44af8]{flex:1;overflow-y:auto;padding:15px}.customer-info[data-v-a7b44af8]{line-height:1.3}.customer-name[data-v-a7b44af8]{color:#333;font-size:12px;font-weight:500}.customer-email[data-v-a7b44af8]{color:#666;font-size:10px}.amount-cell[data-v-a7b44af8]{color:#28a745;font-size:11px;font-weight:600;text-align:right}.status-badge[data-v-a7b44af8]{border-radius:10px;font-size:9px;font-weight:500;padding:2px 6px;text-transform:uppercase}.status-draft[data-v-a7b44af8]{background:#ffeaa7;color:#fdcb6e}.status-sent[data-v-a7b44af8]{background:#74b9ff;color:#0984e3}.status-paid[data-v-a7b44af8]{background:#00b894;color:#00a085}.status-overdue[data-v-a7b44af8]{background:#ff7675;color:#d63031}.status-cancelled[data-v-a7b44af8]{background:#636e72;color:#2d3436}.btn[data-v-a7b44af8]{align-items:center;border:none;border-radius:4px;cursor:pointer;display:inline-flex;font-size:12px;gap:4px;line-height:1.2;padding:6px 12px;transition:all .2s ease}.btn-compact[data-v-a7b44af8]{font-size:12px;padding:5px 10px}.btn-sm[data-v-a7b44af8]{font-size:11px;padding:5px 10px}.btn-xs[data-v-a7b44af8]{font-size:10px;padding:3px 8px}.btn-primary[data-v-a7b44af8]{background:#28a745;color:#fff}.btn-secondary[data-v-a7b44af8]{background:#6c757d;color:#fff}.btn-outline-primary[data-v-a7b44af8]{background:#fff;border:1px solid #007bff;color:#007bff}.btn-outline-success[data-v-a7b44af8]{background:#fff;border:1px solid #28a745;color:#28a745}.btn-outline-info[data-v-a7b44af8]{background:#fff;border:1px solid #17a2b8;color:#17a2b8}.btn-outline-warning[data-v-a7b44af8]{background:#fff;border:1px solid #ffc107;color:#ffc107}.btn[data-v-a7b44af8]:hover:not(:disabled){opacity:.9;transform:translateY(-1px)}.btn[data-v-a7b44af8]:disabled{cursor:not-allowed;opacity:.6;transform:none}.modal-footer[data-v-a7b44af8]{background:#f8f9fa;border-top:1px solid #e9ecef;justify-content:space-between;min-height:50px;padding:10px 15px}.footer-info[data-v-a7b44af8],.modal-footer[data-v-a7b44af8]{align-items:center;display:flex}.result-count[data-v-a7b44af8]{color:#666;font-size:12px}.footer-actions[data-v-a7b44af8]{display:flex;gap:8px;justify-content:flex-end}@media (max-width:768px){.invoice-browser-dialog[data-v-a7b44af8]{border-radius:0;height:100vh;max-height:100vh;width:100%}.form-row[data-v-a7b44af8],.totals-compact[data-v-a7b44af8]{grid-template-columns:1fr}.section-header[data-v-a7b44af8]{align-items:flex-start;flex-direction:column;gap:8px}.quick-allocation-actions[data-v-a7b44af8]{justify-content:flex-start;width:100%}.allocation-table-container[data-v-a7b44af8],.invoice-table-container[data-v-a7b44af8]{overflow-x:auto}.allocation-table .table[data-v-a7b44af8],.invoice-table-container .table[data-v-a7b44af8]{min-width:600px}.footer-actions[data-v-a7b44af8]{flex-direction:column}.footer-actions .btn[data-v-a7b44af8]{justify-content:center;width:100%}.invoice-selector[data-v-a7b44af8]{flex-direction:column;gap:8px}.search-input-group[data-v-a7b44af8]{max-width:100%}}@media (max-width:480px){.modal-header[data-v-a7b44af8]{padding:8px 10px}.modal-title[data-v-a7b44af8]{font-size:14px}.form-section[data-v-a7b44af8]{padding:12px 15px}.amount-summary[data-v-a7b44af8]{padding:10px 15px}.modal-footer[data-v-a7b44af8]{padding:8px 10px}.quick-allocation-actions[data-v-a7b44af8]{flex-direction:column;gap:6px;width:100%}.quick-allocation-actions .btn[data-v-a7b44af8]{justify-content:center;width:100%}}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vuetify-loader/lib/loader.js??ref--4!./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib/loaders/templateLoader.js??ref--7!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/accounting/ar/receive/maintain/index.vue?vue&type=template&id=a7b44af8&scoped=true





var maintainvue_type_template_id_a7b44af8_scoped_true_render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', [_vm.visible ? _vm._ssrNode("<div class=\"modal-overlay\" data-v-a7b44af8>", "</div>", [_c('client-only', [_c('ARReceivePrinter', {
    attrs: {
      "visible": _vm.showPrintDialog,
      "receipt-data": _vm.selectedReceiptForPrint,
      "payment-methods": _vm.paymentMethods,
  ...
  })], 1), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"enhanced-dialog\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<div class=\"modal-header\" data-v-a7b44af8><h4 class=\"modal-title\" data-v-a7b44af8><i class=\"fas fa-receipt\" data-v-a7b44af8></i>" + _vm._ssrEscape("\n          " + _vm._s(_vm.isEdit ? 'ແກ້ໄຂການຮັບຊຳລະ' : 'ເພີ່ມການຮັບຊຳລະໃໝ່') + "\n        ") + "</h4> <button type=\"button\" class=\"close-button\" data-v-a7b44af8><i class=\"fas fa-times\" data-v-a7b44af8></i></button></div> "), _vm._ssrNode("<div class=\"modal-body\" data-v-a7b44af8>", "</div>", [_vm.formLoading ? _vm._ssrNode("<div class=\"loading-state\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<div class=\"spinner\" data-v-a7b44af8></div> <p data-v-a7b44af8>ກຳລັງໂຫຼດຂໍ້ມູນ...</p>")], 2) : _vm._ssrNode("<div class=\"receipt-form\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<form data-v-a7b44af8>", "</form>", [_vm._ssrNode("<div class=\"form-section\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<h5 class=\"section-title\" data-v-a7b44af8><i class=\"fas fa-info-circle\" data-v-a7b44af8></i>\n                ຂໍ້ມູນການຮັບຊຳລະ\n              </h5> "), _vm._ssrNode("<div class=\"form-row\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<div class=\"form-group\" data-v-a7b44af8><label for=\"bookingDate\" class=\"required\" data-v-a7b44af8>ວັນທີບັນທຶກ</label> <input id=\"bookingDate\" type=\"date\"" + _vm._ssrAttr("value", _vm.form.bookingDate) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.bookingDate
  }) + " data-v-a7b44af8> " + (_vm.errors.bookingDate ? "<div class=\"invalid-feedback\" data-v-a7b44af8>" + _vm._ssrEscape("\n                    " + _vm._s(_vm.errors.bookingDate) + "\n                  ") + "</div>" : "<!---->") + "</div> <div class=\"form-group\" data-v-a7b44af8><label for=\"receiptNumber\" class=\"required\" data-v-a7b44af8>ເລກທີໃບຮັບ</label> <input id=\"receiptNumber\" type=\"text\" placeholder=\"RCP-2025-001\"" + _vm._ssrAttr("readonly", _vm.isEdit) + _vm._ssrAttr("value", _vm.form.receiptNumber) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.receiptNumber
  }) + " data-v-a7b44af8> " + (_vm.errors.receiptNumber ? "<div class=\"invalid-feedback\" data-v-a7b44af8>" + _vm._ssrEscape("\n                    " + _vm._s(_vm.errors.receiptNumber) + "\n                  ") + "</div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"form-group\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<label for=\"paymentId\" class=\"required\" data-v-a7b44af8>ວິທີການຊຳລະ</label> "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "id": "paymentId",
  ...
  })], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"form-group\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<label for=\"currencyId\" data-v-a7b44af8>ສະກຸນເງິນ</label> "), _c(VAutocomplete["a" /* default */], {
    attrs: {
      "id": "currencyId",
  ...
  })], 2), _vm._ssrNode(" <div class=\"form-group\" data-v-a7b44af8><label for=\"exchangeRate\" data-v-a7b44af8>ອັດຕາແລກປ່ຽນ</label> <input id=\"exchangeRate\" type=\"number\" step=\"0.0001\" min=\"0\" placeholder=\"1.0000\"" + _vm._ssrAttr("value", _vm.form.exchangeRate) + " class=\"form-control\" data-v-a7b44af8></div> <div class=\"form-group\" data-v-a7b44af8><label for=\"referenceNumber\" data-v-a7b44af8>ເລກອ້າງອີງ</label> <input id=\"referenceNumber\" type=\"text\" placeholder=\"ເລກອ້າງອີງ...\"" + _vm._ssrAttr("value", _vm.form.referenceNumber) + " class=\"form-control\" data-v-a7b44af8></div>")], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"form-row\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<div class=\"form-group\" data-v-a7b44af8><label for=\"receivedDate\" class=\"required\" data-v-a7b44af8>ວັນທີຮັບເງິນ</label> <input id=\"receivedDate\" type=\"date\"" + _vm._ssrAttr("value", _vm.form.receivedDate) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.receivedDate
  }) + " data-v-a7b44af8> " + (_vm.errors.receivedDate ? "<div class=\"invalid-feedback\" data-v-a7b44af8>" + _vm._ssrEscape("\n                    " + _vm._s(_vm.errors.receivedDate) + "\n                  ") + "</div>" : "<!---->") + "</div> "), _vm._ssrNode("<div class=\"form-group\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<label for=\"invoiceHeaderId\" data-v-a7b44af8>ໃບແຈ້ງໜີ້ (ທາງເລືອກ)</label> "), _vm._ssrNode("<div class=\"d-flex align-items-start invoice-selector\" data-v-a7b44af8>", "</div>", [_c(VAutocomplete["a" /* default */], {
  ...
  }), _vm._ssrNode(" <button type=\"button\" title=\"ເລືອກໃບແຈ້ງໜີ້\" class=\"btn btn-outline-primary btn-sm ml-2\" style=\"height: 40px; margin-top: 0\" data-v-a7b44af8><i class=\"fas fa-search\" data-v-a7b44af8></i>\n                      ຄົ້ນຫາ\n                    </button>")], 2), _vm._ssrNode(" <small class=\"form-text text-muted mt-2\" data-v-a7b44af8><i class=\"fas fa-info-circle\" data-v-a7b44af8></i>\n                    ເລືອກໃບແຈ້ງໜີ້ເພື່ອໂຫຼດລາຍການອັດຕະໂນມັດ\n                  </small>")], 2), _vm._ssrNode(" <div class=\"form-group\" data-v-a7b44af8><label for=\"notes\" data-v-a7b44af8>ໝາຍເຫດ</label> <textarea id=\"notes\" rows=\"2\" placeholder=\"ໝາຍເຫດກ່ຽວກັບການຮັບຊຳລະ...\" class=\"form-control textarea-compact\" data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(_vm.form.notes)) + "</textarea></div> " + (_vm.isEdit ? "<div class=\"form-group\" data-v-a7b44af8><label for=\"reason\" class=\"required\" data-v-a7b44af8>ເຫດຜົນຂອງການແກ້ໄຂ</label> <input id=\"reason\" type=\"text\" placeholder=\"ລະບຸເຫດຜົນຂອງການແກ້ໄຂ...\"" + _vm._ssrAttr("value", _vm.form.reason) + _vm._ssrClass("form-control", {
    'is-invalid': _vm.errors.reason
  }) + " data-v-a7b44af8> " + (_vm.errors.reason ? "<div class=\"invalid-feedback\" data-v-a7b44af8>" + _vm._ssrEscape("\n                    " + _vm._s(_vm.errors.reason) + "\n                  ") + "</div>" : "<!---->") + "</div>" : "<!---->"))], 2)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"form-section\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<div class=\"section-header\" data-v-a7b44af8><h5 class=\"section-title\" data-v-a7b44af8><i class=\"fas fa-list\" data-v-a7b44af8></i>\n                  ການແບ່ງປັນຊຳລະ\n                  " + (_vm.allocationLines.length > 0 ? "<span class=\"line-count\" data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(_vm.allocationLines.length)) + "</span>" : "<!---->") + "</h5> <div class=\"action-buttons\" data-v-a7b44af8><button type=\"button\" class=\"btn btn-primary btn-sm\" data-v-a7b44af8><i class=\"fas fa-plus\" data-v-a7b44af8></i>\n                    ເພີ່ມລາຍການ\n                  </button> " + (_vm.selectedInvoice && _vm.hasInvoiceLines ? "<div class=\"quick-allocation-actions\" data-v-a7b44af8><button type=\"button\" title=\"ແບ່ງປັນຍອດເຕັມ\" class=\"btn btn-outline-primary btn-xs\" data-v-a7b44af8><i class=\"fas fa-file-invoice-dollar\" data-v-a7b44af8></i>\n                      ຍອດເຕັມ\n                    </button> <button type=\"button\" title=\"ແບ່ງເທົ່າກັນ\" class=\"btn btn-outline-success btn-xs\" data-v-a7b44af8><i class=\"fas fa-equals\" data-v-a7b44af8></i>\n                      ແບ່ງເທົ່າກັນ\n                    </button> <button type=\"button\" title=\"ແບ່ງຕາມອັດຕາສ່ວນ\" class=\"btn btn-outline-info btn-xs\" data-v-a7b44af8><i class=\"fas fa-percentage\" data-v-a7b44af8></i>\n                      ຕາມອັດຕາສ່ວນ\n                    </button> <button type=\"button\" class=\"btn btn-outline-warning btn-xs\" data-v-a7b44af8><i class=\"fas fa-eraser\" data-v-a7b44af8></i>\n                      ລົບລ້າງ\n                    </button></div>" : "<!---->") + "</div></div> "), _vm.allocationLines.length === 0 ? _vm._ssrNode("<div class=\"no-invoice-state\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<div class=\"empty-content\" data-v-a7b44af8><i class=\"fas fa-list\" data-v-a7b44af8></i> <h4 data-v-a7b44af8>ຍັງບໍ່ມີລາຍການແບ່ງປັນ</h4> <p data-v-a7b44af8>\n                    ເລືອກໃບແຈ້ງໜີ້ເພື່ອໂຫຼດລາຍການອັດຕະໂນມັດ ຫຼື\n                    ເພີ່ມລາຍການດ້ວຍຕົນເອງ\n                  </p> <button type=\"button\" class=\"btn btn-primary\" data-v-a7b44af8><i class=\"fas fa-plus-circle\" data-v-a7b44af8></i>\n                    ເພີ່ມລາຍການທຳອິດ\n                  </button></div>")], 2) : _vm._ssrNode("<div class=\"allocation-table-container\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<div class=\"allocation-notice\" data-v-a7b44af8><i class=\"fas fa-info-circle\" data-v-a7b44af8></i> <span data-v-a7b44af8>ໃສ່ຍອດແບ່ງປັນສຳລັບແຕ່ລະລາຍການ (ລາຍການຈາກໃບແຈ້ງໜີ້ ຫຼື\n                    ລາຍການທີ່ເພີ່ມເອງ)</span></div> "), _vm._ssrNode("<div class=\"allocation-table\" data-v-a7b44af8>", "</div>", [_vm._ssrNode("<table class=\"table table-compact\" data-v-a7b44af8>", "</table>", [_vm._ssrNode("<thead data-v-a7b44af8><tr data-v-a7b44af8><th style=\"width: 30px\" data-v-a7b44af8>#</th> <th style=\"width: 200px\" data-v-a7b44af8>ລາຍລະອຽດ *</th> <th data-v-a7b44af8>ຍອດອ້າງອີງ</th> <th data-v-a7b44af8>ຍອດຊຳລະ *</th> <th data-v-a7b44af8>ລະຫັດການເງິນ <span class=\"required\" data-v-a7b44af8>*</span></th> <th style=\"width: 50px\" data-v-a7b44af8>ລຶບ</th></tr></thead> "), _vm._ssrNode("<tbody data-v-a7b44af8>", "</tbody>", _vm._l(_vm.allocationLines, function (allocation, index) {
    return _vm._ssrNode("<tr class=\"allocation-row\" data-v-a7b44af8>", "</tr>", [_vm._ssrNode("<td class=\"line-number\" data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(index + 1)) + "</td> <td data-v-a7b44af8>" + (allocation.invoiceLine ? "<div class=\"invoice-line-display\" data-v-a7b44af8><div class=\"line-description\" data-v-a7b44af8><strong data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(allocation.invoiceLine.description || 'N/A')) + "</strong></div> <div class=\"line-details\" data-v-a7b44af8>" + _vm._ssrEscape("\n                              ຈຳນວນ:\n                              " + _vm._s(_vm.formatNumber(allocation.invoiceLine.quantity || 0)) + "\n                              ×\n                              " + _vm._s(_vm.formatCurrency(allocation.invoiceLine.unitPrice || 0)) + "\n                              ") + ((allocation.invoiceLine.taxRate || 0) > 0 ? "<span data-v-a7b44af8>" + _vm._ssrEscape("\n                                + ພາສີ " + _vm._s(allocation.invoiceLine.taxRate) + "%\n                              ") + "</span>" : "<!---->") + "</div></div>" : "<div data-v-a7b44af8><input type=\"text\" placeholder=\"ລາຍລະອຽດການແບ່ງປັນ...\"" + _vm._ssrAttr("value", allocation.description) + _vm._ssrClass("form-control form-control-xs", {
      'is-invalid': _vm.errors[`allocation_${index}_description`]
    }) + " data-v-a7b44af8> " + (_vm.errors[`allocation_${index}_description`] ? "<div class=\"invalid-feedback\" data-v-a7b44af8>" + _vm._ssrEscape("\n                              " + _vm._s(_vm.errors[`allocation_${index}_description`]) + "\n                            ") + "</div>" : "<!---->") + "</div>") + "</td> <td class=\"invoice-line-total\" data-v-a7b44af8>" + (allocation.invoiceLine ? "<span data-v-a7b44af8>" + _vm._ssrEscape("\n                            " + _vm._s(_vm.formatCurrency(allocation.invoiceLine.lineTotal)) + "\n                          ") + "</span>" : "<span class=\"text-muted\" data-v-a7b44af8>-</span>") + "</td> <td data-v-a7b44af8><input type=\"number\" step=\"0.01\" min=\"0\"" + _vm._ssrAttr("max", allocation.invoiceLine && allocation.invoiceLine.lineTotal ? allocation.invoiceLine.lineTotal : '') + " placeholder=\"0.00\"" + _vm._ssrAttr("value", allocation.allocatedAmount) + _vm._ssrClass("form-control form-control-xs", {
      'is-invalid': _vm.errors[`allocation_${index}_allocatedAmount`]
    }) + " data-v-a7b44af8> " + (_vm.errors[`allocation_${index}_allocatedAmount`] ? "<div class=\"invalid-feedback\" data-v-a7b44af8>" + _vm._ssrEscape("\n                            " + _vm._s(_vm.errors[`allocation_${index}_allocatedAmount`]) + "\n                          ") + "</div>" : "<!---->") + "</td> "), _vm._ssrNode("<td data-v-a7b44af8>", "</td>", [_c(VAutocomplete["a" /* default */], {
      staticClass: "mt-0",
      attrs: {
    ...
    }), _vm._ssrNode(" " + (!allocation.txnId && _vm.errors.settlementLines ? "<small class=\"text-danger d-block\" data-v-a7b44af8>\n                            ກະລຸນາເລືອກລະຫັດການເງິນ\n                          </small>" : "<!---->"))], 2), _vm._ssrNode(" "), _vm.enableGL ? _vm._ssrNode("<td data-v-a7b44af8>", "</td>", [_c(VAutocomplete["a" /* default */], {
      staticClass: "mt-0",
      attrs: {
    ...
    })], 1) : _vm._e(), _vm._ssrNode(" "), _vm.enableGL ? _vm._ssrNode("<td data-v-a7b44af8>", "</td>", [_c(VAutocomplete["a" /* default */], {
      staticClass: "mt-0",
      attrs: {
        "items": _vm.glAccounts,
        "item-value": "id",
    ...
    })], 1) : _vm._e(), _vm._ssrNode(" <td data-v-a7b44af8><button type=\"button\" title=\"ລຶບລາຍການ\" class=\"btn btn-xs btn-danger\" data-v-a7b44af8><i class=\"fas fa-trash\" data-v-a7b44af8></i></button></td>")], 2);
  }), 0)], 2)])], 2)], 2), _vm._ssrNode(" <div class=\"amount-summary\" data-v-a7b44af8><div class=\"totals-compact\" data-v-a7b44af8><div class=\"total-item\" data-v-a7b44af8><span data-v-a7b44af8>ຍອດທີ່ຮັບ:</span> <span class=\"amount received\" data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.form.totalReceivedAmount))) + "</span></div> <div class=\"total-item\" data-v-a7b44af8><span data-v-a7b44af8>ລວມການແບ່ງປັນ:</span> <span class=\"amount allocated\" data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(_vm.formatCurrency(_vm.calculatedAllocatedTotal))) + "</span></div> <div class=\"total-item success-balance\" data-v-a7b44af8><span data-v-a7b44af8>ສະຖານະ:</span> <span class=\"amount balance balanced\" data-v-a7b44af8><i class=\"fas fa-check-circle\" data-v-a7b44af8></i>\n                    ສົມດຸນ\n                  </span></div></div> <div class=\"balance-info\" data-v-a7b44af8><i class=\"fas fa-info-circle\" data-v-a7b44af8></i> <span data-v-a7b44af8>ຍອດທີ່ຮັບຈະຖືກຄຳນວນອັດຕະໂນມັດຈາກລວມຍອດການແບ່ງປັນທັງໝົດ</span></div></div>")], 2)])]), _vm._ssrNode(" <div class=\"modal-footer\" data-v-a7b44af8><div class=\"footer-actions\" data-v-a7b44af8><button type=\"button\"" + _vm._ssrAttr("disabled", _vm.saving) + " class=\"btn btn-secondary btn-compact\" data-v-a7b44af8><i class=\"fas fa-times\" data-v-a7b44af8></i>\n            ຍົກເລີກ\n          </button> <button type=\"button\"" + _vm._ssrAttr("disabled", _vm.saving || !_vm.isFormValid) + " class=\"btn btn-primary btn-compact\" data-v-a7b44af8>" + (_vm.saving ? "<i class=\"fas fa-spinner fa-spin\" data-v-a7b44af8></i>" : "<i class=\"fas fa-save\" data-v-a7b44af8></i>") + _vm._ssrEscape("\n            " + _vm._s(_vm.saving ? 'ກຳລັງບັນທຶກ...' : _vm.isEdit ? 'ອັບເດດ' : 'ບັນທຶກ') + "\n          ") + "</button> " + (_vm.isEdit ? "<button type=\"button\" title=\"ພິມໃບຮັບເງິນ\" class=\"audit-btn\" data-v-a7b44af8><i class=\"fas fa-print\" data-v-a7b44af8></i> <span class=\"audit-text\" data-v-a7b44af8>ພິມ</span></button>" : "<!---->") + "</div></div>")], 2)], 2) : _vm._e(), _vm._ssrNode(" " + (_vm.showInvoiceBrowser ? "<div class=\"modal-overlay\" data-v-a7b44af8><div class=\"invoice-browser-dialog\" data-v-a7b44af8><div class=\"modal-header\" data-v-a7b44af8><h4 class=\"modal-title\" data-v-a7b44af8><i class=\"fas fa-search\" data-v-a7b44af8></i>\n          ເລືອກໃບແຈ້ງໜີ້\n        </h4> <button type=\"button\" class=\"close-button\" data-v-a7b44af8><i class=\"fas fa-times\" data-v-a7b44af8></i></button></div> <div class=\"modal-body\" data-v-a7b44af8><div class=\"search-section\" data-v-a7b44af8><div class=\"search-input-group\" data-v-a7b44af8><i class=\"fas fa-search search-icon\" data-v-a7b44af8></i> <input type=\"text\" placeholder=\"ຄົ້ນຫາເລກໃບແຈ້ງໜີ້, ຊື່ລູກຄ້າ, ຫຼື ລາຍລະອຽດ...\"" + _vm._ssrAttr("value", _vm.invoiceSearchQuery) + " class=\"form-control search-input\" data-v-a7b44af8></div></div> " + (_vm.invoiceBrowserLoading ? "<div class=\"loading-state\" data-v-a7b44af8><div class=\"spinner\" data-v-a7b44af8></div> <p data-v-a7b44af8>ກຳລັງໂຫຼດໃບແຈ້ງໜີ້...</p></div>" : _vm.searchFilteredInvoices.length > 0 ? "<div class=\"invoice-list\" data-v-a7b44af8><div class=\"invoice-table-container\" data-v-a7b44af8><table class=\"table table-compact\" data-v-a7b44af8><thead data-v-a7b44af8><tr data-v-a7b44af8><th style=\"width: 120px\" data-v-a7b44af8>ເລກໃບແຈ້ງໜີ້</th> <th style=\"width: 180px\" data-v-a7b44af8>ລູກຄ້າ</th> <th style=\"width: 80px\" data-v-a7b44af8>ວັນທີ</th> <th style=\"width: 80px\" data-v-a7b44af8>ຄົບກຳໜົດ</th> <th style=\"width: 90px\" data-v-a7b44af8>ຍອດເງິນ</th> <th style=\"width: 70px\" data-v-a7b44af8>ສະຖານະ</th> <th style=\"width: 70px\" data-v-a7b44af8>ເລືອກ</th></tr></thead> <tbody data-v-a7b44af8>" + _vm._ssrList(_vm.searchFilteredInvoices, function (invoice) {
    return "<tr class=\"invoice-row\" data-v-a7b44af8><td data-v-a7b44af8><strong data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(invoice.invoiceNumber)) + "</strong></td> <td data-v-a7b44af8><div class=\"customer-info\" data-v-a7b44af8><div class=\"customer-name\" data-v-a7b44af8>" + _vm._ssrEscape("\n                        " + _vm._s(invoice.customer ? invoice.customer.name : 'N/A') + "\n                      ") + "</div> " + (invoice.customer && invoice.customer.email ? "<div class=\"customer-email\" data-v-a7b44af8>" + _vm._ssrEscape("\n                        " + _vm._s(invoice.customer.email) + "\n                      ") + "</div>" : "<!---->") + "</div></td> <td data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(_vm.formatDate(invoice.invoiceDate))) + "</td> <td data-v-a7b44af8>" + _vm._ssrEscape(_vm._s(_vm.formatDate(invoice.dueDate))) + "</td> <td class=\"amount-cell\" data-v-a7b44af8>" + _vm._ssrEscape("\n                    " + _vm._s(_vm.formatCurrency(invoice.totalAmount)) + "\n                  ") + "</td> <td data-v-a7b44af8><span" + _vm._ssrClass("status-badge", `status-${invoice.status}`) + " data-v-a7b44af8>" + _vm._ssrEscape("\n                      " + _vm._s(_vm.getStatusLabel(invoice.status)) + "\n                    ") + "</span></td> <td data-v-a7b44af8><button type=\"button\"" + _vm._ssrAttr("disabled", invoice.id === _vm.form.invoiceHeaderId) + " class=\"btn btn-primary btn-xs\" data-v-a7b44af8><i class=\"fas fa-check\" data-v-a7b44af8></i>" + _vm._ssrEscape("\n                      " + _vm._s(invoice.id === _vm.form.invoiceHeaderId ? 'ເລືອກແລ້ວ' : 'ເລືອກ') + "\n                    ") + "</button></td></tr>";
  }) + "</tbody></table></div></div>" : "<div class=\"no-results-state\" data-v-a7b44af8><div class=\"empty-content\" data-v-a7b44af8><i class=\"fas fa-file-invoice\" data-v-a7b44af8></i> <h4 data-v-a7b44af8>" + _vm._ssrEscape("\n              " + _vm._s(_vm.invoiceSearchQuery ? 'ບໍ່ພົບໃບແຈ້ງໜີ້' : 'ບໍ່ມີໃບແຈ້ງໜີ້') + "\n            ") + "</h4> <p data-v-a7b44af8>" + _vm._ssrEscape("\n              " + _vm._s(_vm.invoiceSearchQuery ? `ບໍ່ພົບໃບແຈ້ງໜີ້ທີ່ຕົງກັບ "${_vm.invoiceSearchQuery}"` : 'ບໍ່ມີໃບແຈ້ງໜີ້ທີ່ສາມາດເລືອກໄດ້') + "\n            ") + "</p></div></div>") + "</div> <div class=\"modal-footer\" data-v-a7b44af8><div class=\"footer-info\" data-v-a7b44af8>" + (_vm.searchFilteredInvoices.length > 0 ? "<span class=\"result-count\" data-v-a7b44af8>" + _vm._ssrEscape("\n            ພົບ " + _vm._s(_vm.searchFilteredInvoices.length) + " ໃບແຈ້ງໜີ້\n          ") + "</span>" : "<!---->") + "</div> <div class=\"footer-actions\" data-v-a7b44af8><button type=\"button\" class=\"btn btn-secondary btn-compact\" data-v-a7b44af8><i class=\"fas fa-times\" data-v-a7b44af8></i>\n            ປິດ\n          </button></div></div></div></div>" : "<!---->"))], 2);
};
var staticRenderFns = [];

// CONCATENATED MODULE: ./components/accounting/ar/receive/maintain/index.vue?vue&type=template&id=a7b44af8&scoped=true
...
var component = Object(componentNormalizer["a" /* default */])(
  ...
  maintainvue_type_template_id_a7b44af8_scoped_true_render,
  staticRenderFns,
  false,
  injectStyles,
  "a7b44af8",
