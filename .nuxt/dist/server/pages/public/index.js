...
var publicvue_type_template_id_2be9bdcc_scoped_true_render = function render() {
  ...
  }, [_vm._ssrNode("<div class=\"hero-section\" data-v-2be9bdcc><div class=\"hero-overlay\" data-v-2be9bdcc><div class=\"hero-content\" data-v-2be9bdcc><h1 class=\"hero-title\" data-v-2be9bdcc><span class=\"coffee-icon\" data-v-2be9bdcc>☕</span>\n          Our Delicious Menu\n          <span class=\"sparkle\" data-v-2be9bdcc>✨</span></h1> <p class=\"hero-subtitle\" data-v-2be9bdcc>Crafted with love, served with passion</p></div></div></div> "), _c(VContainer["a" /* default */], {
  ...
  }, [_c('span'), _vm._v(" "), _c('span'), _vm._v(" "), _c('span')])])])]), _vm._ssrNode(" " + (_vm.showTableDialog ? "<div class=\"table-dialog-overlay\" data-v-2be9bdcc><div class=\"table-dialog\" data-v-2be9bdcc><div class=\"dialog-header\" data-v-2be9bdcc><div class=\"header-content\" data-v-2be9bdcc><div class=\"header-icons\" data-v-2be9bdcc><span class=\"table-icon\" data-v-2be9bdcc>🏠</span> <span class=\"sparkle-icon\" data-v-2be9bdcc>✨</span></div> <h3 class=\"header-title\" data-v-2be9bdcc><span class=\"greeting\" data-v-2be9bdcc>May I have your</span> <span class=\"highlight\" data-v-2be9bdcc>Table Number</span> <span class=\"please\" data-v-2be9bdcc>please?</span></h3> <p class=\"header-subtitle\" data-v-2be9bdcc>We'll bring your order right to you! 🍽️</p></div> <button class=\"dialog-close\" data-v-2be9bdcc>×</button></div> <div class=\"dialog-content\" data-v-2be9bdcc><p class=\"dialog-subtitle\" data-v-2be9bdcc>" + _vm._ssrEscape("\n          " + _vm._s(_vm.selectedProduct ? `Perfect! Which table for your "${_vm.selectedProduct.pro_name}"? 🎯` : 'Choose your table so we can serve you perfectly! 🌟') + "\n        ") + "</p> <div class=\"tables-grid\" data-v-2be9bdcc>" + _vm._ssrList(_vm.tables, function (table) {
    return "<div" + _vm._ssrClass("table-card", {
      'selected': _vm.selectedTable === table.number
    }) + " data-v-2be9bdcc><div class=\"table-number\" data-v-2be9bdcc>" + _vm._ssrEscape(_vm._s(table.number)) + "</div> <div class=\"table-name\" data-v-2be9bdcc>" + _vm._ssrEscape(_vm._s(table.name)) + "</div> <div class=\"table-zone\" data-v-2be9bdcc>" + _vm._ssrEscape(_vm._s(table.zone)) + "</div> <div class=\"table-icon-small\" data-v-2be9bdcc>🪑</div></div>";
  ...
  }) + " data-v-2be9bdcc><span class=\"btn-icon\" data-v-2be9bdcc>🔔</span>\n            Call Waiter\n          </button></div></div></div></div>" : "<!---->") + " " + (_vm.imageDialog ? "<div class=\"image-modal\" data-v-2be9bdcc><div class=\"modal-content\" data-v-2be9bdcc><button class=\"close-btn\" data-v-2be9bdcc>×</button> <div class=\"modal-image-container\" data-v-2be9bdcc><img" + _vm._ssrAttr("src", _vm.previewImageUrl) + " alt=\"Product Preview\" class=\"modal-image\" data-v-2be9bdcc></div></div></div>" : "<!---->") + " <div class=\"fab-container\" data-v-2be9bdcc><button" + _vm._ssrClass("fab call-waiter-fab", {
    'calling': _vm.isCallingWaiter
  }) + " data-v-2be9bdcc>" + (!_vm.isCallingWaiter ? "<span data-v-2be9bdcc>🔔</span>" : "<span class=\"calling-icon\" data-v-2be9bdcc>📞</span>") + "</button> <button class=\"fab scroll-fab\" data-v-2be9bdcc><span data-v-2be9bdcc>↑</span></button></div>")], 2);
};
var staticRenderFns = [];
