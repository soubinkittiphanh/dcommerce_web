...
export const MainCategoryForm = () => import('../../components/MainCategoryForm.vue' /* webpackChunkName: "components/main-category-form" */).then(c => wrapFunctional(c.default || c))
...
export const PrintableInvoice = () => import('../../components/PrintableInvoice.vue' /* webpackChunkName: "components/printable-invoice" */).then(c => wrapFunctional(c.default || c))
...
export const ProductPriceManager = () => import('../../components/ProductPriceManager.vue' /* webpackChunkName: "components/product-price-manager" */).then(c => wrapFunctional(c.default || c))
...
export const SpfDialog = () => import('../../components/SpfDialog.vue' /* webpackChunkName: "components/spf-dialog" */).then(c => wrapFunctional(c.default || c))
export const StudentFormCRUD = () => import('../../components/StudentFormCRUD.vue' /* webpackChunkName: "components/student-form-c-r-u-d" */).then(c => wrapFunctional(c.default || c))
export const SystemDetailsDialog = () => import('../../components/SystemDetailsDialog.vue' /* webpackChunkName: "components/system-details-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const TermsAndConditionsDialog = () => import('../../components/TermsAndConditionsDialog.vue' /* webpackChunkName: "components/terms-and-conditions-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const ColorForm = () => import('../../components/colorForm.vue' /* webpackChunkName: "components/color-form" */).then(c => wrapFunctional(c.default || c))
...
export const EnhancedInvoicePrinter = () => import('../../components/enhanced-invoice-printer.vue' /* webpackChunkName: "components/enhanced-invoice-printer" */).then(c => wrapFunctional(c.default || c))
...
export const SimplifiedCompanyForm = () => import('../../components/simplified-company-form.vue' /* webpackChunkName: "components/simplified-company-form" */).then(c => wrapFunctional(c.default || c))
export const SizeForm = () => import('../../components/sizeForm.vue' /* webpackChunkName: "components/size-form" */).then(c => wrapFunctional(c.default || c))
...
export const CAFEPOSDialog = () => import('../../components/CAFE/POSDialog.vue' /* webpackChunkName: "components/c-a-f-e-p-o-s-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const ApplicantsImportDialog = () => import('../../components/applicants/ImportDialog.vue' /* webpackChunkName: "components/applicants-import-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const CardGiftDialog = () => import('../../components/card/GiftDialog.vue' /* webpackChunkName: "components/card-gift-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const CardStockAdjustMent = () => import('../../components/card/stockAdjustMent.vue' /* webpackChunkName: "components/card-stock-adjust-ment" */).then(c => wrapFunctional(c.default || c))
export const CardStockMaintenance = () => import('../../components/card/stockMaintenance.vue' /* webpackChunkName: "components/card-stock-maintenance" */).then(c => wrapFunctional(c.default || c))
export const CommonSystemGuideDialog = () => import('../../components/common/SystemGuideDialog.vue' /* webpackChunkName: "components/common-system-guide-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const DashboardMetricCard = () => import('../../components/dashboard/MetricCard.vue' /* webpackChunkName: "components/dashboard-metric-card" */).then(c => wrapFunctional(c.default || c))
...
export const CustomerOrderSection = () => import('../../components/customer/OrderSection.vue' /* webpackChunkName: "components/customer-order-section" */).then(c => wrapFunctional(c.default || c))
export const CustomerPaymentSection = () => import('../../components/customer/PaymentSection.vue' /* webpackChunkName: "components/customer-payment-section" */).then(c => wrapFunctional(c.default || c))
export const CustomerSuccessOverlay = () => import('../../components/customer/SuccessOverlay.vue' /* webpackChunkName: "components/customer-success-overlay" */).then(c => wrapFunctional(c.default || c))
export const CustomerWelcomeScreen = () => import('../../components/customer/WelcomeScreen.vue' /* webpackChunkName: "components/customer-welcome-screen" */).then(c => wrapFunctional(c.default || c))
export const MemberOffer = () => import('../../components/member_offer/index.vue' /* webpackChunkName: "components/member-offer" */).then(c => wrapFunctional(c.default || c))
export const MemberUsage = () => import('../../components/member_usage/index.vue' /* webpackChunkName: "components/member-usage" */).then(c => wrapFunctional(c.default || c))
...
export const ProductPriceImportDialog = () => import('../../components/product/PriceImportDialog.vue' /* webpackChunkName: "components/product-price-import-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const ProductImportDialog = () => import('../../components/product/ProductImportDialog.vue' /* webpackChunkName: "components/product-import-dialog" */).then(c => wrapFunctional(c.default || c))
export const ProductStockImportDialog = () => import('../../components/product/StockImportDialog.vue' /* webpackChunkName: "components/product-stock-import-dialog" */).then(c => wrapFunctional(c.default || c))
export const PromotionsPromotionDialog = () => import('../../components/promotions/PromotionDialog.vue' /* webpackChunkName: "components/promotions-promotion-dialog" */).then(c => wrapFunctional(c.default || c))
export const QuotationPrint = () => import('../../components/quotation/QuotationPrint.vue' /* webpackChunkName: "components/quotation-print" */).then(c => wrapFunctional(c.default || c))
...
export const PosCartFooterComponent = () => import('../../components/pos/CartFooterComponent.vue' /* webpackChunkName: "components/pos-cart-footer-component" */).then(c => wrapFunctional(c.default || c))
export const PosCartItemComponent = () => import('../../components/pos/CartItemComponent.vue' /* webpackChunkName: "components/pos-cart-item-component" */).then(c => wrapFunctional(c.default || c))
...
export const PosMultiPaymentDialogVue2 = () => import('../../components/pos/MultiPaymentDialog-vue2.vue' /* webpackChunkName: "components/pos-multi-payment-dialog-vue2" */).then(c => wrapFunctional(c.default || c))
export const PosNfcPaymentDialog = () => import('../../components/pos/NfcPaymentDialog.vue' /* webpackChunkName: "components/pos-nfc-payment-dialog" */).then(c => wrapFunctional(c.default || c))
export const PosAppBar = () => import('../../components/pos/PosAppBar.vue' /* webpackChunkName: "components/pos-app-bar" */).then(c => wrapFunctional(c.default || c))
export const PosCartDrawer = () => import('../../components/pos/PosCartDrawer.vue' /* webpackChunkName: "components/pos-cart-drawer" */).then(c => wrapFunctional(c.default || c))
export const PosDialogs = () => import('../../components/pos/PosDialogs.vue' /* webpackChunkName: "components/pos-dialogs" */).then(c => wrapFunctional(c.default || c))
export const PosLeftDrawer = () => import('../../components/pos/PosLeftDrawer.vue' /* webpackChunkName: "components/pos-left-drawer" */).then(c => wrapFunctional(c.default || c))
...
export const RolesRoleCard = () => import('../../components/roles/RoleCard.vue' /* webpackChunkName: "components/roles-role-card" */).then(c => wrapFunctional(c.default || c))
export const RolesRoleDialog = () => import('../../components/roles/RoleDialog.vue' /* webpackChunkName: "components/roles-role-dialog" */).then(c => wrapFunctional(c.default || c))
export const RolesUsersListDialog = () => import('../../components/roles/UsersListDialog.vue' /* webpackChunkName: "components/roles-users-list-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const ReportsProfitLossReport = () => import('../../components/reports/ProfitLossReport.vue' /* webpackChunkName: "components/reports-profit-loss-report" */).then(c => wrapFunctional(c.default || c))
...
export const TicketsNotesDialog = () => import('../../components/tickets/NotesDialog.vue' /* webpackChunkName: "components/tickets-notes-dialog" */).then(c => wrapFunctional(c.default || c))
export const TicketsPrintDialog = () => import('../../components/tickets/PrintDialog.vue' /* webpackChunkName: "components/tickets-print-dialog" */).then(c => wrapFunctional(c.default || c))
export const TicketsTicketCard = () => import('../../components/tickets/TicketCard.vue' /* webpackChunkName: "components/tickets-ticket-card" */).then(c => wrapFunctional(c.default || c))
export const TicketsTicketDetailDialog = () => import('../../components/tickets/TicketDetailDialog.vue' /* webpackChunkName: "components/tickets-ticket-detail-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const CAFEPrintBarDialog = () => import('../../components/CAFE/printBarDialog/index.vue' /* webpackChunkName: "components/c-a-f-e-print-bar-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const CompanyTheme = () => import('../../components/company/theme/index.vue' /* webpackChunkName: "components/company-theme" */).then(c => wrapFunctional(c.default || c))
...
export const AccountingTransaction = () => import('../../components/accounting/transaction/index.vue' /* webpackChunkName: "components/accounting-transaction" */).then(c => wrapFunctional(c.default || c))
...
export const PosDialogsTicketDetailsDialog = () => import('../../components/pos/dialogs/TicketDetailsDialog.vue' /* webpackChunkName: "components/pos-dialogs-ticket-details-dialog" */).then(c => wrapFunctional(c.default || c))
...
export const PosRecipeCurrencySummaryCards = () => import('../../components/pos/recipe/CurrencySummaryCards.vue' /* webpackChunkName: "components/pos-recipe-currency-summary-cards" */).then(c => wrapFunctional(c.default || c))
export const PosRecipe = () => import('../../components/pos/recipe/index.vue' /* webpackChunkName: "components/pos-recipe" */).then(c => wrapFunctional(c.default || c))
...
export const AccountingApSettlementVoucher = () => import('../../components/accounting/ap/settlement/voucher/index.vue' /* webpackChunkName: "components/accounting-ap-settlement-voucher" */).then(c => wrapFunctional(c.default || c))
...
export const AccountingApSettlementBrowsemou = () => import('../../components/accounting/ap/settlement/browsemou/index.vue' /* webpackChunkName: "components/accounting-ap-settlement-browsemou" */).then(c => wrapFunctional(c.default || c))
