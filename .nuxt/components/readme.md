...
- `<MainCategoryForm>` | `<main-category-form>` (components/MainCategoryForm.vue)
...
- `<PrintableInvoice>` | `<printable-invoice>` (components/PrintableInvoice.vue)
- `<ProductCard>` | `<product-card>` (components/ProductCard.vue)
- `<ProductPriceManager>` | `<product-price-manager>` (components/ProductPriceManager.vue)
...
- `<StudentFormCRUD>` | `<student-form-c-r-u-d>` (components/StudentFormCRUD.vue)
- `<SystemDetailsDialog>` | `<system-details-dialog>` (components/SystemDetailsDialog.vue)
- `<TerminalForm>` | `<terminal-form>` (components/TerminalForm.vue)
- `<TermsAndConditionsDialog>` | `<terms-and-conditions-dialog>` (components/TermsAndConditionsDialog.vue)
...
- `<ColorForm>` | `<color-form>` (components/colorForm.vue)
...
- `<SizeForm>` | `<size-form>` (components/sizeForm.vue)
...
- `<ApplicantsImportDialog>` | `<applicants-import-dialog>` (components/applicants/ImportDialog.vue)
...
- `<CommonSystemGuideDialog>` | `<common-system-guide-dialog>` (components/common/SystemGuideDialog.vue)
...
- `<CustomerOrderSection>` | `<customer-order-section>` (components/customer/OrderSection.vue)
- `<CustomerPaymentSection>` | `<customer-payment-section>` (components/customer/PaymentSection.vue)
- `<CustomerSuccessOverlay>` | `<customer-success-overlay>` (components/customer/SuccessOverlay.vue)
- `<CustomerWelcomeScreen>` | `<customer-welcome-screen>` (components/customer/WelcomeScreen.vue)
...
- `<ProductPriceImportDialog>` | `<product-price-import-dialog>` (components/product/PriceImportDialog.vue)
...
- `<ProductImportDialog>` | `<product-import-dialog>` (components/product/ProductImportDialog.vue)
- `<ProductStockImportDialog>` | `<product-stock-import-dialog>` (components/product/StockImportDialog.vue)
- `<PromotionsPromotionDialog>` | `<promotions-promotion-dialog>` (components/promotions/PromotionDialog.vue)
- `<QuotationPrint>` | `<quotation-print>` (components/quotation/QuotationPrint.vue)
...
- `<PosNfcPaymentDialog>` | `<pos-nfc-payment-dialog>` (components/pos/NfcPaymentDialog.vue)
- `<PosAppBar>` | `<pos-app-bar>` (components/pos/PosAppBar.vue)
- `<PosCartDrawer>` | `<pos-cart-drawer>` (components/pos/PosCartDrawer.vue)
- `<PosDialogs>` | `<pos-dialogs>` (components/pos/PosDialogs.vue)
- `<PosLeftDrawer>` | `<pos-left-drawer>` (components/pos/PosLeftDrawer.vue)
...
- `<ReportsProfitLossReport>` | `<reports-profit-loss-report>` (components/reports/ProfitLossReport.vue)
...
- `<PosDialogsTicketDetailsDialog>` | `<pos-dialogs-ticket-details-dialog>` (components/pos/dialogs/TicketDetailsDialog.vue)
...
- `<PosRecipeCurrencySummaryCards>` | `<pos-recipe-currency-summary-cards>` (components/pos/recipe/CurrencySummaryCards.vue)
