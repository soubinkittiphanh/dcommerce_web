  ...
  <v-dialog v-model="dialog" max-width="480" persistent>
    <v-card class="elevation-8">
      ...
      <v-card-title class="pink darken-1 white--text py-3">
        ...
        <span class="text-subtitle-1">{{ isEditMode ? 'ແກ້ໄຂຂອງຂວັນ' : 'ກຳນົດຂອງຂວັນ' }}</span>
        <v-spacer></v-spacer>
      ...
      <v-card-text class="pa-4">
        ...
        <div class="d-flex align-center mb-3 pa-2 pink lighten-5 rounded">
          ...
          <div class="flex-grow-1">
            <div class="font-weight-medium text-body-2">{{ item?.pro_name }}</div>
        ...
        <v-alert v-else type="warning" dense outlined class="text-caption mb-3">
