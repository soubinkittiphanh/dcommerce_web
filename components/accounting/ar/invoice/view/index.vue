  ...
  <div v-if="visible" class="modal-overlay" @click="closeDialog">
    <div class="modal-container" @click.stop>
      ...
      <div class="modal-body" v-if="invoice">
        ...
        <!-- Related Documents -->
        <div class="info-section" v-if="invoice.documents && invoice.documents.length > 0">
          <div class="section-header">
            <h3>
              <i class="fas fa-paperclip"></i>
              ເອກະສານຂັດຕິດ (Attached Documents)
            </h3>
            <span class="item-count">{{ invoice.documents.length }} ໄຟລ໌</span>
          </div>
          
          <div style="display: flex; flex-wrap: wrap; gap: 12px; padding: 8px 0;">
            <div
              v-for="(doc, idx) in invoice.documents"
              :key="idx"
