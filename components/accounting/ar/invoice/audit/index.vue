  ...
  <div v-if="visible" class="invoice-audit-dialog-overlay" @click="handleOverlayClick">
    <div class="invoice-audit-dialog" @click.stop>
      ...
      <div class="invoice-audit-dialog-body">
        <invoice-audit-viewer ref="invoiceAuditViewer" :invoice-id="invoiceId" :auto-load="visible"
          @logs-loaded="onLogsLoaded" />
      </div>

      <!-- Dialog Footer -->
      <div class="invoice-audit-dialog-footer">
        <button type="button" class="btn btn-secondary" @click.stop="handleClose">
          <i class="fas fa-times"></i>
          ປິດ
        </button>
        ...
        <div class="export-options">
          <button type="button" class="btn btn-primary main-export-btn" @click="exportAuditLog" :disabled="isExporting">
          ...
          <div class="export-dropdown">
            <button type="button" class="btn btn-outline-primary dropdown-toggle"
              @click="showExportOptions = !showExportOptions" :disabled="isExporting">
...
export default {
  ...
  methods: {
    ...
    async exportWithJsPDF() {
      ...
      // Create filename
      const filename = `invoice-audit-log-${this.invoiceInfo?.invoiceNumber || this.invoiceId
    ...
    generateHTMLContent() {
      const logs = this.auditLogs
        ...
        <div style="margin-bottom: 20px; padding: 15px; border: 1px solid #ddd; border-radius: 5px;">
          <h4 style="margin: 0 0 10px 0; color: #333;">${index + 1
          ...
          ${log.recordData
            ...
            <div style="margin-top: 10px; padding: 10px; background: #f8f9fa; border-radius: 3px;">
              <p style="margin: 3px 0;"><strong>ເລກທີໃບແຈ້ງໜີ້:</strong> ${log.recordData.invoiceNumber || ''
              }</p>
        ...
        <body>
          ...
          ? `
            <div class="invoice-info">
              <p><strong>ເລກທີໃບແຈ້ງໜີ້:</strong> ${this.invoiceInfo.invoiceNumber
          }</p>
    ...
    exportAsJSON() {
      ...
      try {
        ...
        link.href = url
        link.download = `invoice-audit-log-${this.invoiceInfo?.invoiceNumber || this.invoiceId
