      ...
      <v-card>
        ...
        <v-card-text class="pt-4">
          ...
          >
            ...
            <div
              v-else-if="getCustomerGradePrice(selectedProduct)"
            ...
            <v-list dense class="pa-0">
              ...
              >
                <v-list-item-icon class="mr-3">
                  <v-icon :color="!categoryFilter ? 'primary' : 'grey'"
                ...
                <v-list-item-content>
                  ...
                  <v-list-item-subtitle
                    >{{ products.length }} items</v-list-item-subtitle
                  >
                </v-list-item-content>
              </v-list-item>
              ...
              <v-list-item
                ...
                @click="categoryFilter = category.categ_id"
                :class="{
              ...
              <v-row v-if="filteredProducts.length > 0">
                ...
                >
                  <v-card
                    elevation="2"
                    hover
                    class="text-center pa-3 cursor-pointer product-card"
                    height="auto"
                    min-height="160"
                    :disabled="
                    ...
                    <v-card-text class="pa-1">
                      ...
                      <div class="price-section mb-2">
                        ...
                        >
                          ...
                          <div
                            class="caption grey--text text-decoration-line-through"
                          >
                ...
                <div class="d-flex justify-space-between align-center mb-1">
                  <div class="flex-grow-1 mr-2">
                    ...
                    <div class="caption grey--text">
                      ...
                      <span
                        v-if="item.isCustomerGradePrice"
                        class="success--text"
                      >
                        • Grade {{ selectedCustomer?.grade }}
                      </span>
                      ...
                      <span
                        v-else-if="item.priceOverridden"
                        class="warning--text"
                      >
                        • Modified
                      </span>
